...
$host_name="https://www.pathshala.co/lms";
...
}elseif(preg_match('/(192.168.1.250)/',$host_name)){
	preg_match("~^".$host_name."/shashirai/([^/]+)(.*?)$~",$host_name.$_SERVER['PHP_SELF'],$matches);
	$baseUrl='http://'.$host_name."/shashirai/".$matches[1];	
}else{	
