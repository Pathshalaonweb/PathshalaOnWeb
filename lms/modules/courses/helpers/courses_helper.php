...
if ( ! function_exists('count_course_lession'))
{
	function count_course_lession($condtion='')
	{		
		 $ci = CI();
		 $condtion = "status !='2' ".$condtion;	 
		 $sql="SELECT COUNT(lession_id)  AS total_lession FROM tbl_course_lession WHERE $condtion ";		 
...
if ( ! function_exists('count_course_subject'))
{
	function count_course_subject($condtion='')
	{		
		 $ci = CI();
		 $condtion = "status !='2' ".$condtion;	 
		 $sql="SELECT COUNT(courses_id)  AS total_subject FROM tbl_courses WHERE $condtion ";		 
		 $query=$ci->db->query($sql)->row_array();
