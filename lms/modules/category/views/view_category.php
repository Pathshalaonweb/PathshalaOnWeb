...
<img src="<?php echo base_url();?>uploaded_files/category/<?php echo $val['category_image'];?>" alt="" title="" width="70" height="70" style="height:70px;">
...
<li><?php if($val['category_description']){echo $val['category_description'];}?></li>
