...
<aside class="right-side">
	...
	{
		$sel_q ="SELECT * FROM `tbl_mock` where department_id='".$course[$i]."'  ORDER BY mock_id ASC";
		...
		<div class="row">
			<div class="col-md-12">
				<div class="box box-primary p20" >
					<p><?php echo $v['subject_name'];?></p><span>
					...
					<div class="card">
						...
						<div class="tab-content">
							<div role="tabpanel" class="tab-pane active" id="summary<?php echo $v['subject_id'];?>">
								<?php echo $val['mock_description'];?>
							</div>
