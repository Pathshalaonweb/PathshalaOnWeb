				...
				<div class="x_panel">
					<div class="x_title">
						...
						<ul class="nav navbar-right panel_toolbox">
							<li>
								<?php echo anchor("adminzone/mock/add/$parent_id","Add $heading_title",'class="btn btn-primary" ' );?>
							</li>
						</ul>
						<div class="clearfix"></div>
					</div>
					<div class="x_content">
						...
						{
						?>
						<?php echo form_open("adminzone/mock/",'id="data_form"');?>
						<table id="datatable-checkbox" class="table table-striped table-bordered bulk_action">
							...
							<tbody>
								...
								{ 
									...
									$condtion_test   =  "AND department_id='".$pageVal['category_id']."'";
									$total_test     =  count_test($condtion_test);
								?> 
								<tr>
									<td>
										<input type="checkbox" name="arr_ids[]"class="flat" value="<?php echo  $pageVal['category_id'];?>" />
									...
									<td><?php echo $pageVal['category_name'];?>
										...
										if($total_test>0)
										{
											echo "<br><br>".anchor("adminzone/mock/test/".$pageVal['category_id'],'Mock Test ['. $total_test.']','class="refSection" ' );
										}
										else
										{
											echo "<br>".anchor("adminzone/mock/test/".$pageVal['category_id'],'Mock Test ['. $total_test.']','class="refSection" ');
										}
										?>
									</td>
									<td>
										<label style="display:none"><?php echo $displayorder;?></label>
									...
									<td>
										...
										{
										?>
										<?php echo anchor("adminzone/mock/edit/$pageVal[category_id]/".query_string(),'Edit'); ?>
										<?php
										}
										?>
									</td>
