					...
					<div class="x_content">
						...
						<div class="form-group" id="shwtxt">
							...
							<div class="col-md-6 col-sm-6 col-xs-12">
								<textarea name="question" placeholder="Which among the following elements increases the absorption of water and calcium in plants?"rows="5" cols="50" class="form-control col-md-7 col-xs-12" id="description" ><?php  echo set_value('question',$res['question']);?></textarea>
							</div>
