      ...
      <div class="x_panel">
        ...
        <div class="x_content"> 
          ...
          <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <textarea name="mock_description" rows="5" cols="50" class="form-control col-md-7 col-xs-12" id="description" ><?=set_value('mock_description',$res['mock_description']);?>
</textarea>
          ...
          <div class="form-group">
			  ...
			  ?>
              <option value="<?php echo $val['courses_id'];?>" <?php if($res['course_id']) { echo "selected";}?>><?php echo $val['courses_name'];?>&nbsp; // &nbsp; <?php echo $val['courses_code']?></option>
              <?php }}?>
                </select>
              </div>
            </div>
