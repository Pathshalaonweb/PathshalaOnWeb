					...
					<div class="x_content">
						...
						<div class="form-group">
							...
							<div class="col-md-6 col-sm-6 col-xs-12">
								<input type="text" name="lession_name" class="form-control col-md-7 col-xs-12" size="40" value="<?php echo set_value('lession_name',$res['lession']);?>" />
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-md-6 col-sm-6 col-xs-12">
								<textarea name="courses_description" rows="5" cols="50" class="form-control col-md-7 col-xs-12" id="description" ><?=set_value('courses_description',$res['courses_description']);?></textarea>
