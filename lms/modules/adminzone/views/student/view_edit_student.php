          ...
          <div class="x_content"> <br />
            ...
            <div class="form-group">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                <input type="text" name="name" size="40" class="form-control col-md-7 col-xs-12" value="<?php echo set_value('name',$mres['first_name']);?>" />
              </div>
            </div>
            <!--<div class="form-group">
              <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Email : <span class="required">*</span> </label>
              <div class="col-md-6 col-sm-6 col-xs-12">
                <input type="text" name="user_name" size="40" class="form-control col-md-7 col-xs-12" value="<?php echo set_value('user_name',$mres['user_name']);?>" />
              </div>
            </div>-->
            ...
            <div class="form-group">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                <input type="text" name="mobno" size="40" maxlength="10" class="form-control col-md-7 col-xs-12" value="<?php echo set_value('mobno',$mres['phone_number']);?>" />
              </div>
            </div>
            <div class="form-group">
              <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Course : <span class="required">*</span> </label>
              <?php 
					$sel_q ="SELECT * FROM `tbl_courses` where status='1' ";
					$dept_res=$this->db->query($sel_q);
					if($dept_res->num_rows() > 0)
					{
						$list_dept=$dept_res->result_array();
					}
					$lot = explode(",",$mres['lot']);
				?>
              <div class="col-md-6 col-sm-6 col-xs-12"> 
                ...
                <select class="js-example-placeholder-multiple js-states form-control" multiple="multiple" name="lot[]">
                  ...
                  <option value='<?php echo $dept['category_id'];?>' 
				  <?php 
						for($i=0;$i<count($lot);$i++){
						if($dept['courses_id']==$lot[$i]){ echo "selected";} }?>><?php echo $dept['courses_name'];?></option>
                  <?php }?>
                </select>
              </div>
            </div>
            <?php /*?><div class="form-group">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                <select class="form-control" name="state" onChange="gettown(this.value);">
                  ...
                  <option id="<?php echo $city['category_id'];?>" value="<?php echo $city['category_id'];?>" <?php if($city['category_id']==set_value('state',$mres['state'])){ echo "selected";}?>><?php echo ucfirst($city['category_name']);?></option>
                  <?php }?>
                </select>
              </div>
            </div>
