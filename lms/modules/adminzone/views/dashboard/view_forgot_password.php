        ...
        <tr>
          ...
          <table width="100%" align="right" cellpadding="2"  cellspacing="2" >
            ...
            <tr>
              ...
              <td align="left" valign="middle" bgcolor="#F8F8F8"><p style="float:left;"><input type="text" name="verification_code" id="verification_code" class="input-bdr2" style="width:150px;"></p><p style="float:left;"><img src="<?php echo site_url('captcha/normal'); ?>/sitepanel" class="vam bdr" alt=""  id="captchaimage"/><a href="javascript:viod(0);" title="Change Verification Code"  ><img src="<?php echo base_url(); ?>assets/developers/images/ref.png"  alt="Refresh"  onclick="document.getElementById('captchaimage').src='<?php echo site_url('captcha/normal'); ?>/sitepanel/<?php echo uniqid(time()); ?>'+Math.random(); document.getElementById('verification_code').focus();" class="ml10 vam"></a></p>
