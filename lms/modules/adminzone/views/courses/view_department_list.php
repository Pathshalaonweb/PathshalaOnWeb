				...
				<div class="x_panel">
					<div class="x_title">
						...
						<ul class="nav navbar-right panel_toolbox">
							<li>
								<?php echo anchor("adminzone/courses/add/$parent_id","Add $heading_title",'class="btn btn-primary" ' );?>
							</li>
						</ul>
						<div class="clearfix"></div>
					</div>
					<div class="x_content">
						...
						<?php echo form_open("adminzone/courses/",'id="data_form"');?>
						<table id="datatable-checkbox" class="table table-striped table-bordered bulk_action">
							...
							<tbody>
								...
								{ 
									...
									$total_products     =  count_course_subject($condtion_product);
								?> 
								<tr>
									<td>
									...
									if($total_products>0)
									{
										echo "<br><br>".anchor("adminzone/courses/subject/".$pageVal['category_id'],'Subject ['. $total_products.']','class="refSection" ' );
									}else
									{
										echo "<br>".anchor("adminzone/courses/subject/".$pageVal['category_id'],'Subject ['. $total_products.']','class="refSection" ');
									}
									?>
									</td>
									<td>
									...
									<td>
										...
										{
										?>
										<?php echo anchor("adminzone/courses/edit/$pageVal[category_id]/".query_string(),'Edit'); ?>
										<?php
										}
										?>
									</td>
