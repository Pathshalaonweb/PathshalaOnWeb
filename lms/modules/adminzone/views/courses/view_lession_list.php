                ...
                <div class="x_panel">
					<div class="x_title">
						<ul class="nav navbar-left panel_toolbox" >
							...
							<li>
								<a href="<?php echo base_url();?>adminzone/courses/" style="color:#337ab7"><?php echo $list_dept[0]['category_name'];?> /</a>
							</li> 
							<li>
								<a href="<?php echo base_url();?>adminzone/courses/subject/<?php echo $list_sub['category_id']?>" style="color:#337ab7"><?php echo $list_sub['courses_name'];?> /</a>
							</li> 
							<li>
						...
						<ul class="nav navbar-right panel_toolbox">
							<li>
								<?php echo anchor("adminzone/courses/add_lession/$sub_id","Add $heading_title",'class="btn btn-primary" ' );?>
							</li>
						</ul>
						<div class="clearfix"></div>
					</div>
					<div class="x_content">
						...
						<?php echo form_open("adminzone/courses/lession/$sub_id",'id="data_form"');?>
							...
							<tbody>
								...
								<tr>
									...
									<td><b>
										...
										{
										?>
										<?php echo anchor("adminzone/courses/edit_lession/$pageVal[lession_id]/".query_string(),'Edit'); ?>
										<?php
										}
										?>
										</b>
