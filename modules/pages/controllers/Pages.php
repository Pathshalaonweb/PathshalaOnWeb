...
class Pages extends Public_Controller
{
		...
		{			    
			...
			$this->form_validation->set_rules('first_name','First Name','trim|alpha|xss_clean|required|max_length[30]');
			$this->form_validation->set_rules('email','Email','trim|required|valid_email|xss_clean|max_length[80]');
			$this->form_validation->set_rules('phone_number','Phone','trim|xss_clean|max_length[20]');	
			$this->form_validation->set_rules('subject','Subject','trim|required|xss_clean|max_length[40]');
			$this->form_validation->set_rules('address','company’s address ','trim|xss_clean|max_length[250]');			
			...
			{			
				...
				$body .= '<br /><br />Subject : '.$this->input->post('subject');	
