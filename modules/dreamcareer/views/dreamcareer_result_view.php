...
<div class="breadcrumb-area">
                ...
                <div class="col-md-8">
                  <tr>
                    <td>
                      ...
                      $sqll = "SELECT * FROM `wl_dc_questions`  where id='12'";
                      $qu = $this->db->query($sqll);
                      foreach ($qu->result_array() as $vall) :
                        echo "12 ";
                        echo $vall['question'];
                    ...
                    <td>
                      ...
                      <select id="ans12" name="ans12[]" multiple required class="form-control">
                        <//?php
                           $dbe = $this->load->database('default', TRUE);
                           $sq="SELECT distinct(programme_name) FROM `wl_dc_colleges`";
                           $query=$dbe->query($sq);
                           if($query->num_rows()>0){
                           foreach($query->result_array() as $list):
                            ?>                  
                         <option value="<//?php echo $list['college_id']; ?>"><//?php echo $list['programme_name']; ?></option>
                        <//?php  endforeach; }?>
                      </select>
                    </td>
                  </tr>
  ...
  <?php // echo validation_message();?> 
    ...
    <?php echo form_open('dreamcareer/studentResult', 'class="form", method="post", accept-charset="utf-8", onsubmit="return validate()"'); ?>
