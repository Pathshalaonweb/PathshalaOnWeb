  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-7 col-md-12 ml-auto mr-auto">
        ...
        <form action="<?php echo base_url(); ?>dreamcareer/dreamcareer_result_view" method="post" accept-charset="utf-8" onsubmit="return validate()">
                 ...
                 <input type="number" name="phone_number" placeholder="Phone" id="phone" value="<?php echo set_value('phone_number'); ?>" min="5000000000" max="9999999999" step=1>Number should be of 10 Digits
				  ...
				  <input type="referralcode" name="referralcode" id="referralcode" placeholder="Referral Code(Enter Referral Code)" value="<?php echo set_value('referralcode');?>DREAMCAREER">
