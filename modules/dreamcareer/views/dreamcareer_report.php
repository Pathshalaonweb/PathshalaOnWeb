...
<?php
$con=mysqli_connect("localhost", "root","Pathshala@1a", "pathshal_pathshala");
$email = $this->input->post('user_name',TRUE);
//echo $email;
$em = "SELECT * FROM `wl_customers` where `user_name`='$email'";
$v1 = mysqli_query($con,$em);
$q1=mysqli_fetch_assoc($v1);
$rid = "SELECT * FROM `wl_dc_response` where `emailid`='$email' ORDER BY response_id DESC limit 1";
$r_id = mysqli_query($con,$rid);
$response=mysqli_fetch_assoc($r_id);
//$q1=implode($q2);
?>
    <div class="login-register-area pt-20 pb-20">
        ...
        <div class="tbl col-lg-12 col-md-12 ml-auto mr-auto pt-40 pb-40">
            <p> Registeration ID: <?php  echo date("Y"); ?>/<?php echo date("M");?>/<?php echo $q1['customers_id'];?>/<?php echo $response['response_id'];?></p>
            <p> Name: <?php echo $q1['first_name'];?></p>
            <p> Email ID: <?php echo $q1['user_name'];?></p>
            <!---<div class="row">
                <div class="col-md-4">
