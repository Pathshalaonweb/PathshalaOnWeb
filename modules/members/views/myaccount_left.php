    ...
    <div class="sidebar-search mb-40">
      <div class="sidebar-title mb-15">
        ...
        <ul>
          ...
          <li><a href="<?php echo base_url();?>members/credithistory"><?php if(!empty($mem_info['credit_point'])){echo "Wallet/Credit History :<strong>(".$mem_info['credit_point'].")</strong>";}else{echo "Wallet/Credit History :<strong>(00)</strong>";}?></a></li>
