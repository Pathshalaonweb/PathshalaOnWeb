...
<br>
<br>
<h3 class="section-heading" align="center">Register as Educator or Institute or Counsellor</h3>
<div class="container">
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-7 col-md-12 ml-auto mr-auto">
        ...
        <form action="<?php echo base_url(); ?>affiliate/teacherRegister" method="post" accept-charset="utf-8" onsubmit="return validate()">
