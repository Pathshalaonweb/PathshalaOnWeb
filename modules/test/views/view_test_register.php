...
<html lang="en">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="masthead__content masthead__content-mtop">
                            <h1 class="masthead__content-title">Start Build Amazing  Marketing Product</h1>
                            <p class="masthead__content-subtitle">Build complete awesome marketing website with amazing landingpage template</p>
                            
                            <div class="masthead__content-action">
                                <a href="javascript:void(0)" class="btn btn-orange btn-rounded btn-icon-left btn-lg js-video-button" data-video-id="TKnufs85hXk"><i class="fa fa-play"></i> Video Tour</a>
                    ...
                    <div class="col-lg-6 text-center">
                        <div class="masthead__style-watter--image">
                            <div class="masthead__style-watter--icon flyIn">
                                <img src="<?php echo base_url();?>uploaded_files/userfiles/images/masthead-icon.png" class="img-fluid" alt="Icon" />
                            </div>
                            <img src="<?php echo base_url();?>uploaded_files/userfiles/images/businessmanmeditating.png" class="img-fluid" alt="Business Man" />
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="section pt-0 pb-60">
        <div class="container">
            <div class="row">
                <div class="col-lg-8 mb-40">
                    <img src="<?php echo base_url();?>uploaded_files/userfiles/images/lady-with-handphone.png" class="img-fluid" alt="Lady with handphone" />
                </div>
                <div class="col-lg-4 align-self-center mb-40">
                    ...
                    <div class="col-md-8 offset-lg-2">
                        <fieldset class="section__cta-subscribe">
                            <form name="ctaSubscribe" action="">
                                <input type="text" class="section__cta-subscribe-input" placeholder="Enter your email address" />
                                <button type="button" class="default-btn" type="submit">Subscribe <i class="fa fa-long-arrow-right"></i></button>
                            </form>
                        </fieldset>
                    </div>
                </div>
...
<html lang="en">
    ...
    <section class="masthead js-masthead-height text-center pb-0">
        <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-8 offset-lg-2">
                        <div class="masthead__content">
                            <h1 class="masthead__content-title">Landing page and marketing website</h1>
            ...
            <img src="<?php echo base_url();?>uploaded_files/userfiles/images/masthead-img-work.png" class="masthead__content-image" alt="Masthead Image" />
        </div>
    </section>
    <!-- End Masthead -->
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 mb-40">
                    <img src="<?php echo base_url();?>uploaded_files/userfiles/images/vector-younglady-with-laptop.png" class="img-fluid" alt="Young lady with laptop" />
                </div>
                <div class="col-lg-6 mb-40">
                ...
                <div class="col-lg-4 mb-40">
                    ...
                    <div class="masthead__form">
                        <form name="register" action="">
                            <div class="form-group">
                                ...
                                <input type="text" name="first_name" class="form-control" id="name" placeholder="Enter your full name" value="<?php echo set_value('first_name'); ?>">
                  ...
                  <?php echo form_error('first_name');?>
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" name="user_name" class="form-control" id="email" placeholder="Enter your emali address"value="<?php echo set_value('user_name');?>">                  
								
                            </div>
							</div>
                            <div class="form-group">
                                <label for="inputEmail">Phone Number</label>
                                <input type="number" name="phone_number" class="form-control" id="phone" placeholder="Enter your phone number" id="phone" value="<?php echo set_value('phone_number'); ?>" min="5000000000" max="9999999999" step=1>
                  ...
                  <?php echo form_error('phone_number');?>
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" name="password" class="form-control" id="password" placeholder="Create Your Password" value="<?php echo set_value('password');?>">
								
                            </div>
                            <div class="button-box">
                                <button type="button" class="default-btn" type="submit">Get started <i class="fa fa-long-arrow-right"></i></button>
                            </div>
                        </form>
                    </div>
                </div>
                ...
                <div class="col-lg-12">
                    <div class="owl-active-nav">
                        <div class="owl-carousel js-owl-screenshot">
                            <!-- Start screenhot 01 -->
                            <div class="item">
                                <img src="<?php echo base_url();?>uploaded_files/userfiles/images/video-cover-app.png" class="img-fluid" alt="App dashboard" />
                            </div>
                            <!-- End screenhot 01 -->
