<?php
class Acadex extends Public_Controller
{
	public function __construct()
	{
		parent::__construct(); 
		$this->load->model(array('acadex/acadex_model','payment/payment_model','order/order_model'));
	...
	{	
        ...
        $config['base_url']    = base_url().'acadex/ajaxPaginationData';
        $config['total_rows']  = $totalRec;
        $config['per_page']    = $this->perPage;
        $config['link_func']   = 'searchFilter';
        $this->ajax_pagination->initialize($config);
        //get the posts data
        $data['res'] = $this->acadex_model->get_course_row(array('limit'=>$this->perPage));
        $data['totalRec']=$totalRec;
        //load the view
		$data['heading_title'] = "Advanced Search";						
		 $this->load->view('acadex/view_acadex',$data);
	}
	...
	public  function ajaxPaginationData(){
        ...
        //get posts data
        $data['res'] = $this->acadex_model->get_course_row($conditions);
        //echo_sql();
        //load the view
        $this->load->view('acadex/view_search_acadex', $data, false);
		}
