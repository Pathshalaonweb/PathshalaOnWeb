        ...
        <div class="col-15 hero-text-image">
          <div class="row">
            <div class="col-lg-15 text-center text-lg-center">
              <h1 data-aos="fade-right">Skills of the Master Stroke - Talent Pool</h1>
              <p class="mb-5" data-aos="fade-right" data-aos-delay="100">Join us & be a part of these sessions</p>
      ...
      <div class="container">
        ...
        <div class="row justify-content-center text-center mb-5">
          <div class="col-md-5" data-aos="fade-up">
            <h2 class="section-heading">AcadeX - Tutor's best master skills</h2>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-md-4" data-aos="fade-up" data-aos-delay="">
            <div class="feature-1 text-center">
              ...
              <h3 class="mb-3">Academic Experts - Share your knowledge</h3>
          ...
          <div class="col-md-4" data-aos="fade-up" data-aos-delay="100">
            <div class="feature-1 text-center">
              ...
              <h3 class="mb-3">AcadeX - Who, Why and What as an Academic Expert?</h3>
           <!--   <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Rem, optio.</p>-->
            </div>
          </div>
          <div class="col-md-4" data-aos="fade-up" data-aos-delay="200">
            <div class="feature-1 text-center">
              ...
              <h3 class="mb-3">Acadex - Brand Your Trust</h3>
            <!--  <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Rem, optio.</p>-->
            </div>
          </div>
        </div>
      ...
      <div class="col-lg-7 col-md-12 ml-auto mr-auto">
        <div class="login-register-wrapper">
          <div class="login-register-tab-list nav"> <a class="active" data-toggle="tab" href="#lg2">
            <h2 class="section-heading" align="center">Register as Speaker</h2>
            </a> </div>
        ...
        <form action="<?php echo base_url(); ?>acadex/acadexRegisterTeacher" method="post" accept-charset="utf-8" onsubmit="return validate()">
