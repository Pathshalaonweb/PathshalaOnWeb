                  ...
                  <div class="login-form-container">
					...
					<?php echo error_message(); ?>
      				<?php echo form_open_multipart('teacherdashboard/profile/add'); ?>
                        ...
                        <input type="text" name="location" value="<?php echo set_value('location');?>" placeholder="Specific location">
                                  <input type="text" name="fee" value="<?php echo set_value('fee');?>" placeholder="fee per hour">
