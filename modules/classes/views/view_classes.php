...
<?php echo form_open(current_url_query_string(),'id="myform" method="get" ');?> 
  <div class="radius-5 bg-white shadow p15" id="my_data">
    <h1>FAQ's</h1>
    <p class="tree mt5"><img src="<?php echo theme_url(); ?>images/youarehere.png" alt="" class="vat mr5"> <a href="<?php echo base_url();?>">Home</a> Class</p>
...
if(is_array($res) && !empty($res))
{
	foreach($res as $val)
	{
      ...
      <div class="bg-faq shadow1">
        <p class="abel fs20 b"><?php echo $val['name'];?></p>
...
{
	?>
    <div class="mt30 ac"><strong>Sorry, No Class Here.</strong></div>
    <?php
}
?> 
      <!--FAQ-Ends-->
