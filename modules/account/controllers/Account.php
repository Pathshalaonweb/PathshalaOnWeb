...
class Account extends Public_Controller
{
	...
	{
		parent::__construct(); 
		$this->load->model(array('account/account_model','payment/payment_model','order/order_model'));
	...
	{	
		...
		// $data['heading_title'] = "Advanced Search";						
		 $this->load->view('account/view_account_student');
	}
...
/*payment gateway paytm integration END*/	
	...
	//  {
	// 	$this->load->view('account/view_account_register_student');
	//  }
	 public function welcome()
	 {
		...
		switch($id)
		{
			...
			break;
			case "teacher":
				$this->load->view('account/view_account_teacher');
			break;
			default:
	 ...
	 public function studentRegister()
	 {
		 ...
		 //if($category == "")
		 //{
			//echo "<script>alert('Please Select a account'); window.location = '".base_url()."account/register/student'</script>";
		// }
		...
		if($jsonOutput['message'] == "Invalid user")
		{
			...
			if($jsonSignup['Result']['msg'] == "Item has been added")
			{
				...
				//{
				//$sqq = "INSERT INTO `wl_account_register` (`emailid`, `account_enrolled`, `user_type`, `user_category`, `ip`) values ('".$email."','".$category[$i]."', '1', '2','".$ip."')";
					//echo $sqq;
				//$que = $dbe->query($sqq); 
				//}
			...
			{
				echo "<script>alert('Error Occured. Please Try Again'); window.location = '".base_url()."account/student'</script>";
		...
		else if($jsonOutput['message'] == "Invalid password")
		{
			...
			for($i=0;$i<count($category);$i++)
			{
			$sqq = "INSERT INTO `wl_account_register` (`emailid`, `account_enrolled`, `user_type`, `user_category`, `ip`) values ('".$email."','".$category[$i]."', '0', '2','".$ip."')";
			$que = $dbe->query($sqq); 
			}
			echo "<script>alert('Registered Successfully!'); window.location = '".base_url()."'</script>";
...
public function parentRegister()
	 {
		 ...
		 if($category == "")
		 {
			echo "<script>alert('Please Select a account'); window.location = '".base_url()."account/register/parent'</script>";
		 }
		$category_str = implode(",",$category);
		//print_r($category);
		$password = $this->input->post('password',TRUE);
		...
		if($jsonOutput['message'] == "Invalid user")
		{
			...
			if($jsonSignup['Result']['msg'] == "Item has been added")
			{
				...
				for($i=0;$i<count($category);$i++)
				{
				$sqq = "INSERT INTO `wl_account_register` (`emailid`, `account_enrolled`, `user_type`, `user_category`, `ip`) values ('".$email."','".$category[$i]."', '1', '1','".$ip."')";
					//echo $sqq;
				$que = $dbe->query($sqq); 
				}
				echo "<script>alert('Registered Successfully!'); window.location = '".base_url()."'</script>";
			...
			{
				echo "<script>alert('Error Occured. Please Try Again'); window.location = '".base_url()."account/register/parent'</script>";
		...
		else if($jsonOutput['message'] == "Invalid password")
		{
			...
			for($i=0;$i<count($category);$i++)
			{
			$sqq = "INSERT INTO `wl_account_register` (`emailid`, `account_enrolled`, `user_type`, `user_category`, `ip`) values ('".$email."','".$category[$i]."', '0', '1','".$ip."')";
			$que = $dbe->query($sqq); 
			}
			echo "<script>alert('Registered Successfully!'); window.location = '".base_url()."'</script>";
	 ...
	 public function teacherRegister()
	 {
		// $category = $this->input->post('category',TRUE);
		 //if($category == "")
		 //{
		//	echo "<script>alert('Please Select a account'); window.location = '".base_url()."account/register/teacher'</script>";
		 //}
		//$category_str = implode(",",$category);
		//print_r($category);
		$password = $this->input->post('password',TRUE);
		...
		if($jsonOutput['message'] == "Invalid user")
		{
			...
			//	for($i=0;$i<count($category);$i++)
			//	{
			//	$sqq = "INSERT INTO `wl_account_register` (`emailid`, `account_enrolled`, `user_type`, `user_category`, `ip`) values ('".$email."','".$category[$i]."', '1', '3','".$ip."')";
			//		//echo $sqq;
			//	$que = $dbe->query($sqq); 
			//	}
				echo "<script>alert('Registered Successfully!'); window.location = '".base_url()."'</script>";
			...
			{
				echo "<script>alert('Error Occured. Please Try Again'); window.location = '".base_url()."account/teacher'</script>";
		...
		else if($jsonOutput['message'] == "Invalid password")
		{
			...
			for($i=0;$i<count($category);$i++)
			{
			$sqq = "INSERT INTO `wl_account_register` (`emailid`, `account_enrolled`, `user_type`, `user_category`, `ip`) values ('".$email."','".$category[$i]."', '0', '3','".$ip."')";
			$que = $dbe->query($sqq); 
			}
			echo "<script>alert('Registered Successfully!'); window.location = '".base_url()."'</script>";
