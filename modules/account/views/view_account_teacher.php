...
<h1 class="educatorheading">Welcome to Pathshala - Educator</h1>
<div class="container-02">
		<div class="glassmorphic-card">
			
			<div class="contentBox">
				<h3 class="contentBox">01</h3>
				<p class="contentBox">Sign Up</p>
        ...
        <div class="glassmorphic-card">
			...
			<div class="contentBox">
				<h3 class="contentBox">02</h3>
				<p class="contentBox">Create Profile</p>
        ...
        <div class="glassmorphic-card">
			...
			<div class="contentBox">
				<h3 class="contentBox">03</h3>
				<p class="contentBox">Search Engine</p>
        ...
        <div class="glassmorphic-card">
			...
			<div class="contentBox">
				<h3 class="contentBox">04</h3>
				<p class="contentBox">Join the Club</p>
...
<div class="container right-panel-active">
	...
	<div class="container__form container--signup">
        ...
        <?php echo form_open('account/teacherRegister', 'class="form", id="form1", method="post", accept-charset="utf-8", onsubmit="return validate()"'); ?>
	...
	<div class="container__form container--signin">
		<div class="login-form-container">
				...
				<?php echo validation_message();?> 
				<?php echo error_message(); ?> 
				<?php echo form_open('teacher/login','class="form",id="form2"');?>
				<h2 class="form__title">Sign In</h2>
				  ...
				  <div class="link">
                     <a href="<?php echo base_url();?>teacher/forgotten_password"> Forgot Password</a></div>
