        ...
        <div class="col-15 hero-text-image">
          <div class="row">
            <div class="col-lg-15 text-center text-lg-center">
              <h1 data-aos="fade-right">Grab the Knowledge from the Academic Experts</h1>
              <p class="mb-5" data-aos="fade-right" data-aos-delay="100">Be a part of these sessions</p>
      ...
      <div class="col-lg-7 col-md-12 ml-auto mr-auto">
        <div class="login-register-wrapper">
          <div class="login-register-tab-list nav"> <a class="active" data-toggle="tab" href="#lg2">
            <h2 class="section-heading" align="center">Register as Attendee</h2>
            </a> </div>
      ...
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-md-6" data-aos="fade-left">
            <img src="<?php echo base_url(); ?>softland/assets/img/undraw_svg_2.svg" alt="Image" class="img-fluid">
          </div>
        </div>
      </div>
    </section>
      ...
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-md-6" data-aos="fade-right">
            <img src="<?php echo base_url(); ?>softland/assets/img/undraw_svg_3.svg" alt="Image" class="img-fluid">
          </div>
        </div>
      </div>
    </section>
...
<!--
<!--                <p class="review-user">
<!--                  <img src="<?php echo base_url(); ?>softland/assets/img/person_1.jpg" alt="Image" class="img-fluid rounded-circle mb-3">
<!--                  <span class="d-block">
...
<!--
<!--                <p class="review-user">
<!--                  <img src="<?php echo base_url(); ?>softland/assets/img/person_2.jpg" alt="Image" class="img-fluid rounded-circle mb-3">
<!--                  <span class="d-block">
...
<!--
<!--                <p class="review-user">
<!--                  <img src="<?php echo base_url(); ?>softland/assets/img/person_3.jpg" alt="Image" class="img-fluid rounded-circle mb-3">
<!--                  <span class="d-block">
