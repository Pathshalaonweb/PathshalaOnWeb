...
class Staticpages extends Admin_Controller {
	...
	{		
		 ...
		 public  function index()
	 {
		 ...
		 $res_array              =    $this->pages_model->get_cms_page_admin($config['limit'],$offset);	
	...
	public function add()
	{
		...
		$data['ckeditor']  =  set_ck_config(array('textarea_id'=>'page_desc'));					
				...
				$this->form_validation->set_rules('page_name', 'Name','trim|required|max_length[250]');
				...
				if ($this->form_validation->run() == TRUE)
				{
						...
						'friendly_url'=>url_title($this->input->post('page_name',TRUE)),
