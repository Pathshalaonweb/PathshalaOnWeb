...
<div class="box">
  <div class="heading">
    ...
    <div class="buttons"> <?php echo anchor("adminzone/customsearch/add/",'<span>Add Customsearch</span>','class="button" ' );?></div>
  </div>
  <script type="text/javascript">function serialize_form() { return $('#pagingform').serialize(); } </script>
  <div class="content">
    <?php 

	 echo form_open("adminzone/customsearch/",'id="search_form" method="get"');?>
        ...
        <td align="center" >Search (<span class="left">Question</span>)
          ...
          <?php	
					 ...
					 { 
					    ...
					    echo anchor("adminzone/customsearch/",'<span>View All</span>');
    ...
    <?php 
...

		 {
		  ...
		  echo form_open("adminzone/customsearch/",'id="data_form" ');
    ...
    <table class="list" width="100%" id="my_data">
      <thead>
        <tr>
          ...
          <td width="405" class="left">Title</td>
          <td width="73" align="center">city</td>
      ...
      <tbody>
        <?php 
		   ...
		   ?>
        <tr>
          <td style="text-align: center;"><input type="checkbox" name="arr_ids[]" value="<?php echo $pageVal['customsearch_id'];?>" /></td>
          <td class="left"><?php echo $pageVal['title'];?></td>
          <td class="center"><?php echo $pageVal['city'];?></td>
          <td class="center"><input type="text" name="ord[<?php echo $pageVal['customsearch_id'];?>]" value="<?php echo $pageVal['sort_order'];?>" size="2"  /></td>
          <td class="center"><?php echo ($pageVal['status']==1)?"Active":"In-active";?></td>
          <td class="center"><?php echo anchor("adminzone/customsearch/edit/$pageVal[customsearch_id]/".query_string(),'Edit'); ?></td>
        </tr>
        <?php
