...
<div class="content">
  ...
  <div class="breadcrumb">
	...
	<?php echo form_open_multipart("adminzone/news/edit/".$res['news_id']);?>  
		<div id="tab_pinfo">
			...
			<tr class="trOdd">
			  ...
			  <td width="72%" align="left"><input type="text" name="news_title" size="40" value="<?php echo set_value('news_title',$res['news_title']);?>" /></td>
			  </tr>
			<tr class="trOdd">
                <td height="26" align="right">Comment : <span class="required">*</span></td>
                <td>
               <textarea name="news_description" rows="5" cols="50" id="news_description" >
			   <?php echo set_value('news_description',$res['news_description']);?></textarea>
