...
<div id="content">
<div class="breadcrumb"> <?php echo anchor('adminzone/dashbord','Home'); ?>&raquo; <?php echo anchor('adminzone/discoupon/','Back To Listing'); ?> &raquo; <?php echo $heading_title; ?> </div>
<div class="box">
  <div class="heading">
    <h1><img src="<?php echo base_url(); ?>assets/adminzone/image/category.png" alt="" /> <?php echo $heading_title; ?></h1>
    <div class="buttons">&nbsp;</div>
  </div>
  <div class="content"> <?php echo validation_message();?> <?php echo error_message(); ?> <?php echo form_open('adminzone/coupons/add/');?>
    <div id="tab_pinfo">
      <table width="90%"  class="form"  cellpadding="3" cellspacing="3">
        ...
        <tr class="trOdd">
          ...
          <td width="72%" align="left"><input type="text" name="coupon_discount" size="40" value="<?php echo set_value('coupon_discount');?>">
            [Ex : Percentage: 5, Amount: 120.00 ]</td>
        </tr>
        <?php /*?><tr class="trOdd">
          <td height="26" align="right" >Minimum order amount</td>
          <td align="left"><input type="text" name="minimum_order_amount" size="40" value="<?php echo set_value('minimum_order_amount');?>" />
            [Ex : Amount: 1520.00 ] </td>
        </tr><?php */?>
        <?php /*?><tr class="trOdd">
          <td width="28%" height="26" align="right" >Start Date : <span class="required">*</span></td>
          <td width="72%" align="left"><input name="start_date" class="start_date1" type="text" style="padding:2px; width:133px;" value="<?php echo set_value('start_date');?>">
        ...
        <tr class="trOdd">
          ...
          <td width="72%" align="left"><input name="end_date" class="end_date1" type="text" style="padding:2px; width:133px;" value="<?php echo set_value('end_date');?>">
        ...
        <tr class="trOdd">
          ...
          <td align="left"><input type="submit" name="sub" value="Add" class="button2" />
            <input type="hidden" name="action" value="addtestimonial" /></td>
        </tr>
      </table>
    </div>
