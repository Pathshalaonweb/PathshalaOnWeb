    ...
    <table class="list" width="100%" id="my_data">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td class="left"><?php echo $pageVal['coupon_code'];?> <br />
            </td>
          <td class="center"><?php  if($pageVal['coupon_type']=='p') { echo $pageVal['coupon_discount']."%"; }else{ echo $pageVal['coupon_discount']; } ?></td>
          <td class="center"> <!--Start date : --><?php //echo getDateFormat($pageVal['start_date'],1);?><br>
            End date : <?php echo getDateFormat($pageVal['end_date'],1);?></td>
         
          <td class="center"><?php echo ($pageVal['status']==1)? "Active":"In-active";?></td>
          <td align="center" ><?php echo anchor("adminzone/coupons/edit/$pageVal[coupon_id]/".query_string(),'Edit'); ?></td>
        </tr>
        <?php
			}		   
			?>
      ...
      <tr>
        <td height="35" colspan="7" align="left" style="padding:2px"><input name="status_action" type="submit"  value="Activate" class="button2" id="Activate" onclick="return validcheckstatus('arr_ids[]','Activate','Record','u_status_arr[]');"/>
