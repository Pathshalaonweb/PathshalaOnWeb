    ...
    <table class="list" width="100%" id="my_data">
      <thead>
        <tr>
		  ...
		  <td width="174" align="center">Image Thumbnail</td>
		  <td width="174" align="center">Image Details</td>
          <td width="173" align="center">View Post</td>
          <td width="73" align="center">Order </td>
         <td width="148" class="left">Display Home</td>
      ...
      <tbody>
        ...
        <tr>
		  ...
		  <td align="center">
                    ...
                    <img src="<?php echo get_image('blog',$pageVal['blog_image_thumbnail'],50,50,'AR');?>" />
                    
                     </td>
		<td align="center">
                    
                    <img src="<?php echo get_image('blog',$pageVal['blog_image'],50,50,'AR');?>" />
          ...
          <a onclick="return confirm('Are you sure to Display <?php echo $pageVal['name'];?> at Home page?')" href="<?php echo base_url();?>adminzone/blog/yes/<?php echo $pageVal['blog_id'];?>">NO</a>
          <?php }else{?>
          <a onclick="return confirm('Are you sure to REmove Display <?php echo $pageVal['name'];?> at Home page?')" href="<?php echo base_url();?>adminzone/blog/no/<?php echo $pageVal['blog_id'];?>"><span style="color:#F00;">YES</span></a>
          <?php }?>
          </td>
