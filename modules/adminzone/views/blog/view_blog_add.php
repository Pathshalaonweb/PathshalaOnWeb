...
<div id="content">
<div class="breadcrumb"> <?php echo anchor('adminzone/dashbord','Home'); ?> &raquo; <?php echo anchor('adminzone/blog','Back To Listing'); ?> &raquo; <?php echo $heading_title; ?> </div>
<div class="box">
  <div class="heading">
  ...
  <div class="content"> <?php echo validation_message();?> <?php echo error_message(); ?> <?php echo form_open_multipart('adminzone/blog/add/');?>
    <table width="90%"  class="tableList" align="center">
	  ...
	  <tr class="trOdd">
        <td height="26">Blog Image Thumbnail: <span class="required">*</span></td>
        <td><input type="file"  name="blog_image_thumbnail"/>
			<br />
            <br />
	  ...
	  <tr class="trOdd">
        <td height="26">Blog Image Details: <span class="required">*</span></td>
