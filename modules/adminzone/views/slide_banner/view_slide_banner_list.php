...
<div class="box">
  <div class="heading">
    ...
    <div class="buttons"> <?php echo anchor("adminzone/slide_banner/add/",'<span>Add Slide Banner</span>','class="button" ' );?> </div>
  </div>
  <div class="content">
    <?php 
                if(error_message() !=''){
                ...
                ?>
    <?php echo form_open("adminzone/slide_banner/",'id="form" method="get" '); ?>
    <div align="right" class="breadcrumb"> Records Per Page : <?php echo display_record_per_page();?> </div>
    <table width="100%"  border="0" cellspacing="3" cellpadding="3" >
      <tr>
        <td align="center" >Search [ Banner Title ]
    ...
    <table class="list" width="100%" id="my_data">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td class="left"><?php echo $pageVal['banner_title'];?></td>
          
          <td align="center"><?php
		 $j=1;
		 $product_path = "banner/".$pageVal['banner_image'];
		?>
            <img src="<?php echo get_image('banner',$pageVal['banner_image'],100,100,'AR');?>" /></td>
          <td class="center"><?php echo ($pageVal['status']==1)? "Active":"In-active";?></td>
          <td align="center" ><?php echo anchor("adminzone/slide_banner/edit/$pageVal[banner_id]/".query_string(),'Edit'); ?></td>
        </tr>
        <?php
		$j++;
		}		   
		?>
        <tr>
          <td colspan="15" align="right" height="30"><?php echo $page_links; ?></td>
        </tr>
      </tbody>
      <tr>
        <td align="left" colspan="15" style="padding:2px" height="35"><input name="status_action" type="submit"  value="Activate" class="button2" id="Activate" onClick="return validcheckstatus('arr_ids[]','Activate','Record','u_status_arr[]');"/>
