...
<div class="box">
  <div class="heading">
    ...
    <div class="buttons"> <?php echo anchor("adminzone/subjects/add/",'<span>Add Subject</span>','class="button" ' );?></div>
  </div>
  <script type="text/javascript">function serialize_form() { return $('#pagingform').serialize(); } </script>
  <div class="content">
    <?php 
	 echo form_open("adminzone/subjects/",'id="search_form" method="get"');?>
    ...
    <table width="100%"  border="0" cellspacing="3" cellpadding="3" >
      <?php 
                ...
                ?>
      <tr>
        <td align="center" >Search (<span class="left">Subject</span>)
          <input type="text" name="keyword" value="<?php echo $this->input->get_post('keyword');?>"  />
          &nbsp; <a  onclick="$('#search_form').submit();" class="button"><span> GO </span></a>
          <?php	
					 if( $this->input->get_post('keyword')!='' )
					 { 
					    echo anchor("adminzone/subjects/",'<span>View All</span>');
					 }
					 ?></td>
      </tr>
    </table>
    ...
    <?php 
		 ...
		 {
		  echo form_open("adminzone/subjects/",'id="data_form" ');
    ...
    <table class="list" width="100%" id="my_data">
      <thead>
        <tr>
          ...
          <td width="405" class="left">Subject</td>
      ...
      <tbody>
        <?php 
		   ...
		   ?>
        <tr>
          <td style="text-align: center;"><input type="checkbox" name="arr_ids[]" value="<?php echo $pageVal['subjects_id'];?>" /></td>
          <td class="left"><?php echo $pageVal['subjects'];?></td>
          <td class="center"><a href="#"  onclick="$('#dialog_<?php echo $pageVal['subjects_id'];?>').dialog( {width: 650} );">View Detail</a>
            <!--<div id="dialog_<?php echo $pageVal['subjects_id'];?>" title="Answer" style="display:none;"> <?php echo $pageVal['faq_answer'];?></div></td>-->
          <td class="center"><input type="text" name="ord[<?php echo $pageVal['subjects_id'];?>]" value="<?php echo $pageVal['sort_order'];?>" size="2"  /></td>
          <td class="center"><?php echo ($pageVal['status']==1)?"Active":"In-active";?></td>
          <td class="center"><?php echo anchor("adminzone/subjects/edit/$pageVal[subjects_id]/".query_string(),'Edit'); ?></td>
        </tr>
        <?php
		   }		  
		  ?>
