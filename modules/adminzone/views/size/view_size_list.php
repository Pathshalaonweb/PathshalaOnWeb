<?php $this->load->view('includes/header'); ?>  
 ...
 <div class="box">
    ...
    <div class="heading">
      ...
      <div class="buttons">  <?php echo anchor("adminzone/size/add/",'<span>Add Size</span>','class="button" ' );?></div>
     ...
     <?php echo error_message(); ?>
      ...
      <?php 
	       ...
	       echo form_open("adminzone/size/",'id="search_form" method="get" ');?>
					 ...
					 <?php if($this->input->get_post('keyword')!='')
					   {
					     ...
					     echo anchor("adminzone/size/",'<span>Clear Search</span>');
	 ...
	 <?php 
	   if( is_array($res) && !empty($res) )
	  {
	    ...
	    echo form_open("adminzone/size/",'id="data_form"');?>
	  ...
	  <table class="list" width="100%" id="my_data">
        ...
        <thead>
          <tr>
            ...
            <td width="405" class="left">Size Name</td>
        ...
        <tbody>
          ...
          <tr>
            ...
            <input type="checkbox" name="arr_ids[]" value="<?php echo $pageVal['size_id'];?>" /></td>
            <td class="left"><?php echo $pageVal['size_name'];?></td>
		    <td class="center"><?php echo ($pageVal['status']==1)?"Active":"In-active";?></td>
            <td class="center"><?php echo anchor("adminzone/size/edit/$pageVal[size_id]/".query_string(),'Edit'); ?></td>
          </tr>
          <?php
		   $j++;}		  
		  ?> 
