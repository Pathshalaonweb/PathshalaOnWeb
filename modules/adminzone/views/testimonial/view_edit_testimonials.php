...
<div class="content">
  ...
  <div class="breadcrumb">
	...
	<?php echo form_open_multipart("adminzone/testimonial/edit/".$res['testimonial_id']);?>  
		<div id="tab_pinfo">
			...
			<tr class="trOdd">
			  ...
			  <td align="left"><input type="radio" name="featured" value="Y" <?php if($res['featured']=='Y'){?> checked="checked" <?php }?> /> Yes &nbsp;&nbsp;<input type="radio" name="featured" value="N" <?php if($res['featured']=='N'){?> checked="checked" <?php }?> /> No </td>
			  </tr>
			<tr class="trOdd">
