...
<?php echo form_open("adminzone/courses/related/".$this->uri->segment(4),'id="myform"');?>
<table width="90%" align="left" cellpadding="1" cellspacing="1" class="list" style="margin-top:10px;">
  ...
  <tr>
 <td colspan="3" align="center"><font color="#FF0000"><strong><?php echo $this->session->flashdata('message');?></strong> </font></td>
  </tr>
	<?php 
  ...
  ?>
  <tr>
    <td><input type="checkbox" name="arr_ids[]" value="<?php echo $val['courses_id'];?>" /></td>
  ...
  ?>
  <tr>
    <td colspan="3"><input name="add_related" type="submit"  value="Add related course" class="button2" id="Activate" onClick="return validcheckstatus('arr_ids[]','Add related ','Record','u_status_arr[]');"/>
      <input type="hidden" name="ref_id" value="<?php echo $this->uri->segment(4);?>" /></td>
  </tr>
<?php 
}else {
