...
<div class="box">
  <div class="heading">
    ...
    <div class="buttons"> <?php echo anchor("adminzone/studentplan/add/",'<span>Add Plan</span>','class="button" ' );?></div>
  </div>
  <script type="text/javascript">function serialize_form() { return $('#pagingform').serialize(); } </script>
  <div class="content">
    <?php 
	 echo form_open("adminzone/studentplan/",'id="search_form" method="get"');?>
      ...
      <tr>
        <td align="center" >Search (<span class="left">Name</span>)
          ...
          <?php	
					 ...
					 { 
					    echo anchor("adminzone/studentplan/",'<span>View All</span>');
					 }
					 ?></td>
      </tr>
    </table>
    ...
    <?php 
		 ...
		 {
		  echo form_open("adminzone/studentplan/",'id="data_form" ');
    ...
    <table class="list" width="100%" id="my_data">
      <thead>
        <tr>
          ...
          <td width="200" class="left">Plan name</td>
          <td width="100" align="center">price</td>
          <td width="100" align="center">validaty</td>
          <td width="100" align="center">Credit Point</td>
	  ...
	  ?>
        <tr>
          <td style="text-align: center;"><input type="checkbox" name="arr_ids[]" value="<?php echo $pageVal['plan_id'];?>" /></td>
          <td class="left"><?php echo $pageVal['name'];?></td>
          <td class="center"><?php echo $pageVal['price'];?></td>
          <td class="center"><?php echo $pageVal['validity'];?></td>
          <td class="center"><?php echo $pageVal['credit_point']?></td>
          <td class="center"><input type="text" name="ord[<?php echo $pageVal['plan_id'];?>]" value="<?php echo $pageVal['sort_order'];?>" size="2"  /></td>
          <td class="center"><?php echo ($pageVal['status']==1)?"Active":"In-active";?></td>
          <td class="center"><?php echo anchor("adminzone/studentplan/edit/$pageVal[plan_id]/".query_string(),'Edit'); ?></td>
        </tr>
        <?php
		   }		  
		  ?>
