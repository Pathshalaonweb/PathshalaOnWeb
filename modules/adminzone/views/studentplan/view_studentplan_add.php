...
<div class="box">
  ...
  <div class="content"> <?php echo validation_message();?> <?php echo error_message(); ?> <?php echo form_open_multipart('adminzone/studentplan/add/',array('id'=>'form'));?>
    <table width="90%"  class="tableList" align="center">
      ...
      <tr class="trOdd">
       ...
       <tr class="trOdd">
        <td height="26">Credit Point : <span class="required">*</span></td>
        <td><input type="text" name="credit_point" size="40" value="<?php echo set_value('credit_point');?>"></td>
      </tr>
      <?php /*?><tr class="trOdd">
        <td height="26">validity In Month : <span class="required">*</span></td>
