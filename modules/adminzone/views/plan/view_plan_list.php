...
<div class="box">
  <div class="heading">
    ...
    <div class="buttons"> <?php echo anchor("adminzone/plan/add/",'<span>Add Plan</span>','class="button" ' );?></div>
  </div>
  <script type="text/javascript">function serialize_form() { return $('#pagingform').serialize(); } </script>
  <div class="content">
    <?php 
	 echo form_open("adminzone/plan/",'id="search_form" method="get"');?>
      ...
      <tr>
        <td align="center" >Search (<span class="left">Name</span>)
          ...
          <?php	
					 ...
					 { 
					    echo anchor("adminzone/plan/",'<span>View All</span>');
					 }
					 ?></td>
      </tr>
    </table>
    ...
    <?php 
		 ...
		 {
		  echo form_open("adminzone/plan/",'id="data_form" ');
    ...
    <table class="list" width="100%" id="my_data">
	  ...
	  ?>
        <tr>
          ...
          <td class="center"><?php echo anchor("adminzone/plan/edit/$pageVal[plan_id]/".query_string(),'Edit'); ?></td>
        </tr>
        <?php
		   }		  
		  ?>
