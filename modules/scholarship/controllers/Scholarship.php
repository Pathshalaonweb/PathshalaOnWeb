<?php
class Scholarship extends Public_Controller
{
	public function __construct()
	{
		parent::__construct(); 
		$this->load->model(array('scholarship/scholarship_model','payment/payment_model','order/order_model'));
	...
	{	
		...
		// $data['heading_title'] = "Advanced Search";						
		 $this->load->view('scholarship/view_scholarship_register_student');
	}
	...
	//  }
	 public function register()
	 {
		...
		switch($id)
		{
			...
			break;
			case "teacher":
				$this->load->view('scholarship/view_scholarship_register_teacher');
			break;
			case "parent":
				$this->load->view('scholarship/view_scholarship_register_parent');
			break;
			default:
	 ...
	 public function studentRegister()
	 {
		 ...
		 if($category == "")
		 {
			echo "<script>alert('Please Select a scholarship'); window.location = '".base_url()."scholarship/register/student'</script>";
		 }
		...
		if($jsonOutput['message'] == "Invalid user")
		{
			...
			if($jsonSignup['Result']['msg'] == "Item has been added")
			{
				...
				{
				$sqq = "INSERT INTO `wl_scholarship_register` (`emailid`, `scholarship_enrolled`, `user_type`,`ip`) values ('".$email."','".$category[$i]."', '1','".$ip."')";
					//echo $sqq;
				$que = $dbe->query($sqq); 
				}
			...
			{
				echo "<script>alert('Error Occured. Please Try Again'); window.location = '".base_url()."scholarship/register/student'</script>";
		...
		else if($jsonOutput['message'] == "Invalid password")
		{
			...
			for($i=0;$i<count($category);$i++)
			{
			$sqq = "INSERT INTO `wl_scholarship_register` (`emailid`, `scholarship_enrolled`, `user_type`, `ip`) values ('".$email."','".$category[$i]."', '0','".$ip."')";
			$que = $dbe->query($sqq); 
			}
			echo "<script>alert('Registered Successfully!'); window.location = '".base_url()."'</script>";
...
public function parentRegister()
	 {
		 ...
		 if($category == "")
		 {
			echo "<script>alert('Please Select a scholarship'); window.location = '".base_url()."scholarship/register/parent'</script>";
		 }
		$category_str = implode(",",$category);
		//print_r($category);
		$password = $this->input->post('password',TRUE);
		...
		if($jsonOutput['message'] == "Invalid user")
		{
			...
			if($jsonSignup['Result']['msg'] == "Item has been added")
			{
				...
				for($i=0;$i<count($category);$i++)
				{
				$sqq = "INSERT INTO `wl_scholarship_register` (`emailid`, `scholarship_enrolled`, `user_type`, `user_category`, `ip`) values ('".$email."','".$category[$i]."', '1', '1','".$ip."')";
					//echo $sqq;
				$que = $dbe->query($sqq); 
				}
				echo "<script>alert('Registered Successfully!'); window.location = '".base_url()."'</script>";
			...
			{
				echo "<script>alert('Error Occured. Please Try Again'); window.location = '".base_url()."scholarship/register/parent'</script>";
		...
		else if($jsonOutput['message'] == "Invalid password")
		{
			...
			for($i=0;$i<count($category);$i++)
			{
			$sqq = "INSERT INTO `wl_scholarship_register` (`emailid`, `scholarship_enrolled`, `user_type`, `user_category`, `ip`) values ('".$email."','".$category[$i]."', '0', '1','".$ip."')";
			$que = $dbe->query($sqq); 
			}
			echo "<script>alert('Registered Successfully!'); window.location = '".base_url()."'</script>";
	 ...
	 public function teacherRegister()
	 {
		 ...
		 if($category == "")
		 {
			echo "<script>alert('Please Select a scholarship'); window.location = '".base_url()."scholarship/register/teacher'</script>";
		 }
		$category_str = implode(",",$category);
		//print_r($category);
		$password = $this->input->post('password',TRUE);
		...
		if($jsonOutput['message'] == "Invalid user")
		{
			...
			if($jsonSignup['Result']['msg'] == "Item has been added")
			{
				...
				for($i=0;$i<count($category);$i++)
				{
				$sqq = "INSERT INTO `wl_scholarship_register` (`emailid`, `scholarship_enrolled`, `user_type`, `user_category`, `ip`) values ('".$email."','".$category[$i]."', '1', '3','".$ip."')";
					//echo $sqq;
				$que = $dbe->query($sqq); 
				}
				echo "<script>alert('Registered Successfully!'); window.location = '".base_url()."'</script>";
			...
			{
				echo "<script>alert('Error Occured. Please Try Again'); window.location = '".base_url()."scholarship/register/teacher'</script>";
		...
		else if($jsonOutput['message'] == "Invalid password")
		{
			...
			for($i=0;$i<count($category);$i++)
			{
			$sqq = "INSERT INTO `wl_scholarship_register` (`emailid`, `scholarship_enrolled`, `user_type`, `user_category`, `ip`) values ('".$email."','".$category[$i]."', '0', '3','".$ip."')";
			$que = $dbe->query($sqq); 
			}
			echo "<script>alert('Registered Successfully!'); window.location = '".base_url()."'</script>";
