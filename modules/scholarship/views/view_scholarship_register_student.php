...
<head>
  ...
  <!-- Favicons -->
  <link href="<?php echo base_url(); ?>softland/assets/img/favicon.png" rel="icon">
  <link href="<?php echo base_url(); ?>softland/assets/img/apple-touch-icon.png" rel="apple-touch-icon">
...
<!--  </header>
  ...
  <section class="hero-section" id="hero">
    ...
    <div class="container">
      <div class="row align-items-center">
        <div class="col-15 hero-text-image">
          <div class="row">
            <div class="col-lg-15 text-center text-lg-center">
              <h1 data-aos="fade-right">Test your knowledge by giving Online Assessment & get a chance to win pathshala scholarship</h1>
              <p class="mb-5" data-aos="fade-right" data-aos-delay="100">Be a part of Scholarship Exam<p>
              <p data-aos="fade-right" data-aos-delay="200" data-aos-offset="-500"><a href="#" class="btn btn-outline-white">Get started</a></p>
            </div>
            <!--<div class="col-lg-5 iphone-wrap">
              <img src="<?php echo base_url(); ?>softland/assets/img/phone_1.png" alt="Image" class="phone-1" data-aos="fade-right">
              <img src="<?php echo base_url(); ?>softland/assets/img/phone_2.png" alt="Image" class="phone-2" data-aos="fade-right" data-aos-delay="200">
            </div>-->
          </div>
        </div>
      </div>
 ...
 <section class="section">
        ...
        <div class="row justify-content-center text-center mb-5">
          <div class="col-md-6" data-aos="fade-up">
            <h2 class="section-heading">Talent has no restraint - Watch Your Depth</h2>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-md-4" data-aos="fade-up" data-aos-delay="">
            <div class="feature-1 text-center">
              ...
              <h3 class="mb-3">Self Assessment - Rate Accuracy & Time</h3>
          ...
          <div class="col-md-4" data-aos="fade-up" data-aos-delay="100">
            <div class="feature-1 text-center">
              ...
              <h3 class="mb-3">Realtime Analysis</h3>
             <!-- <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Rem, optio.</p>-->
            </div>
          </div>
          <div class="col-md-4" data-aos="fade-up" data-aos-delay="200">
            <div class="feature-1 text-center">
              ...
              <h3 class="mb-3">Check Sponsorship Eligibility</h3>
             <!-- <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Rem, optio.</p>-->
            </div>
          </div>
        </div>
      ...
      <div class="col-lg-7 col-md-12 ml-auto mr-auto">
        <div class="login-register-wrapper">
          <div class="login-register-tab-list nav"> <a class="active" data-toggle="tab" href="#lg2">
            <h4>Student Scholarship Registration</h4>
            </a> </div>
        ...
        <form action="<?php echo base_url(); ?>scholarship/studentRegister" method="post" accept-charset="utf-8" onsubmit="return validate()">
                 ...
                 <input type="number" name="phone_number" placeholder="Phone" id="phone" value="<?php echo set_value('phone_number'); ?>" min="5000000000" max="9999999999" step=1>
                  ...
                  <input type="password" name="password" id="password" placeholder="Password(Set Your Online Scholarship Password)" value="<?php echo set_value('password');?>">
                  <h4 style="font-family: 'Roboto', sans-serif; color: #1b68b5;">Scholarships</h4>
				 <select id="category" name="category" required>
				  <option value="" selected disabled>Please Select a Scholarship Class</option>
                        <?php 
                  $dbe = $this->load->database('default', TRUE);
                  $sql="SELECT * FROM `wl_scholarship` WHERE user_category='2' ORDER BY id";
                  $query=$dbe->query($sql);
                  if($query->num_rows()>0){
                  foreach($query->result_array() as $val):
                  ?>                  
                   <option value="<?php echo $val['id']; ?>"><?php echo $val['scholarship_name']; ?></option>
                  <?php  endforeach;  } ?>
                  </select>
                <br>     
...
$(document).ready(function(){
    ...
    if(categoryID){
       $.ajax({
          type:'POST',
            url:'<?php echo base_url();?>scholarship/register/student/getSubcat',
...
function getSubcatNext(val) {
	...
	$.ajax({
	type: "POST",
	url: "<?php echo base_url();?>scholarship/register/student/getSubcatNext",
