...
<div class="checkout-area pt-20 pb-20">
  <div class="container">
    <div class="row">
	  ...
	  if($res['price']==1){
	  ?>
      <form action="<?php echo base_url();?>virtualcamp/freepayment" method="post">
      <?php }else{?>
      <form action="<?php echo base_url();?>virtualcamp/payment" method="post">
      <?php }?>
        ...
        <div class="col-lg-5">
          <div class="your-order-area">
            <h3>Virtual Camp Registration</h3>
