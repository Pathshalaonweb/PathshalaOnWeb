      ...
      <div class="col-lg-7 col-md-12 ml-auto mr-auto">
        <div class="login-register-wrapper">
          <div class="login-register-tab-list nav"> <a class="active" data-toggle="tab" href="#lg2">
            <h4> Register for Upcoming Classes</h4>
            </a> </div>
        ...
        <form action="<?php echo base_url(); ?>liveclasses/studentRegister" method="post" accept-charset="utf-8" onsubmit="return validate()">
