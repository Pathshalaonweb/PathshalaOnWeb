...
class Searchtest_model extends MY_Model
 {
	...
	public function get_teacher_row($params=array()) {
		...
		if(!empty($params['search']['pincode'])){
			$this->db->where('b.pincode',$params['search']['pincode']);
        }
		...
		if(!empty($params['search']['category'])){
			$this->db->where('b.category',$params['search']['category']);
        }
		if(!empty($params['search']['bath_time'])){
			
			$this->db->where('b.bath_time',$params['search']['bath_time']);
        }
		//search by price
