	...
	<div class="container-fluid">
		...
		<div class="container">
			<!-- multistep form -->
				...
				if ($res['price'] == 1) {
				?>
					<form action="<?php echo base_url(); ?>courses/freepayment" id="msform" method="post">
					<?php } else { ?>
						<form action="<?php echo base_url(); ?>courses/payment" id="msform" method="post">
						<?php } ?>
						<!-- progressbar -->
						<ul id="progressbar">
						...
						<fieldset>
							...
							?>
								<fieldset>
									<h2 class="fs-title">Your Plan</h2>
									Course
									<input type="text" name="course" value=" <?php echo $res['courses_name'] ?>" disabled />
									Amount
									<input type="number" name="amount" value="<?php echo "00.00"; ?>" disabled />
									Tax
									<input type="number" name="tax" value="<?php echo "00.00"; ?>" disabled />
									Total Payable
									<input type="number" name="net_amount" value="<?php echo "00.00"; ?>" disabled />
									Net Payable
									<input type="number" name="net_amount" value="<?php echo "00.00"; ?>" disabled />
                ...
                <div class="payment-accordion element-mrg"> </div>
							...
							?>
								<fieldset>
									...
									Amount
									<input type="number" name="amount" placeholder="<?php echo $price; ?>" disabled />
									Tax<input type="hidden" name="tax_amount" value="<?php echo $tax_amount; ?>">
									<input type="number" name="tax" value="<?php echo $tax_amount; ?>" disabled />
									Total Payable
									<input type="number" name="net_amount" value="<?php echo $res['price'] + $tax_amount; ?>" disabled />
									Net Payable
									<input type="number" name="net_amount" value="<?php echo round($totalAmount); ?>" disabled />
									<input type="button" name="previous" class="previous btn-hover" value="Previous" />
									<!--<input type="submit" name="submit" class="submit action-button" value="Submit" />-->
									<input type="submit" class="btn-hover"  value="Pay Now">
									<div class="payment-method">
