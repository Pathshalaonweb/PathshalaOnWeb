...
class Astroshop extends  REST_Controller {


	public function __construct()
	{
		parent::__construct(); 
		$this->load->model(array('astroshop_model'));
   ...
   public function list_post()
	{	
		 ...
		 $param = array('status'=>'1','page_type'=>'3');
		 $res_array               = $this->astroshop_model->get_astroshop($param);	
		...
		foreach($res_array as $val){
			...
			if($val['pages_image']==""){
			 $image_url=0;
			   ...
			   $image_url = "https://www.astropatrika.com/uploaded_files/astroshop/".$val['pages_image'];
			}
			
			if($val['pages_image1']==""){
			 $image_url1="0";
			}else{
			   $image_url1 = "https://www.astropatrika.com/uploaded_files/astroshop/".$val['pages_image1'];
			}
