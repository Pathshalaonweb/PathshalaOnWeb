...
(21, 18, 'adfasdfsa', 'adfasdfsa', '<p>adfasdfsadf</p>', '0', 0, '', NULL, NULL);
...
CREATE TABLE IF NOT EXISTS `wl_categories` (
  ...
  `friendly_url` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
...
(7, 'Math', 'math', 'Ariel2jm0P.jpg', '', 0, 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '1', '', '', ''),
(12, 'Biology', 'biology', 'images_(1)LhgM.jpg', '', 0, 3, '2013-04-04 09:07:54', '0000-00-00 00:00:00', '1', NULL, NULL, NULL),
(30, 'Physics', 'physics', '', NULL, 0, NULL, '2019-06-06 16:18:03', '0000-00-00 00:00:00', '1', NULL, NULL, NULL),
(31, 'Chemistry', 'chemistry', '', NULL, 0, NULL, '2019-06-06 16:18:31', '0000-00-00 00:00:00', '1', NULL, NULL, NULL),
(32, 'Class 5', 'class-5', '', NULL, 30, NULL, '2019-06-06 16:19:50', '0000-00-00 00:00:00', '1', NULL, NULL, NULL),
(33, 'Class 6', 'class-6', '', NULL, 30, NULL, '2019-06-06 16:19:59', '0000-00-00 00:00:00', '1', NULL, NULL, NULL),
(34, 'Class 7', 'class-7', '', NULL, 30, NULL, '2019-06-06 16:20:08', '0000-00-00 00:00:00', '1', NULL, NULL, NULL),
(35, 'Class 8', 'class-8', '', NULL, 30, NULL, '2019-06-06 16:20:17', '0000-00-00 00:00:00', '1', NULL, NULL, NULL),
(36, 'Class 9', 'class-9', '', NULL, 30, NULL, '2019-06-06 16:20:25', '0000-00-00 00:00:00', '1', NULL, NULL, NULL),
(37, 'Class 10', 'class-10', '', NULL, 30, NULL, '2019-06-06 16:20:33', '0000-00-00 00:00:00', '1', NULL, NULL, NULL),
(38, 'Class 5', 'class-5', '', NULL, 31, NULL, '2019-06-06 16:20:57', '0000-00-00 00:00:00', '1', NULL, NULL, NULL),
(39, 'Class 6', 'class-6', '', NULL, 31, NULL, '2019-06-06 16:21:07', '0000-00-00 00:00:00', '1', NULL, NULL, NULL),
(40, 'Class 7', 'class-7', '', NULL, 31, NULL, '2019-06-06 16:21:18', '0000-00-00 00:00:00', '1', NULL, NULL, NULL),
(41, 'Class 8', 'class-8', '', NULL, 31, NULL, '2019-06-06 16:21:25', '0000-00-00 00:00:00', '1', NULL, NULL, NULL),
(42, 'Class 9', 'class-9', '', NULL, 31, NULL, '2019-06-06 16:21:36', '0000-00-00 00:00:00', '1', NULL, NULL, NULL),
(43, 'Class 10', 'class-10', '', NULL, 31, NULL, '2019-06-06 16:21:47', '0000-00-00 00:00:00', '1', NULL, NULL, NULL);
...
--
-- Table structure for table `wl_courses`
--

DROP TABLE IF EXISTS `wl_courses`;
CREATE TABLE IF NOT EXISTS `wl_courses` (
  `courses_id` int(11) NOT NULL AUTO_INCREMENT,
  `category_id` int(11) DEFAULT NULL COMMENT 'parent_id= last level of category ',
  `teacher_id` int(11) DEFAULT NULL,
  `category_links` varchar(80) DEFAULT NULL,
  `course_name` varchar(200) DEFAULT NULL,
  `course_friendly_url` varchar(110) DEFAULT NULL,
  `course_code` varchar(64) DEFAULT NULL,
  `courses_description` text,
  `course_price` decimal(15,0) DEFAULT '0',
  `course_discounted_price` decimal(15,0) DEFAULT '0',
  `hot_course` enum('1','0') DEFAULT '0' COMMENT '1=Yes,0=No',
  `featured_course` enum('1','0') DEFAULT '0' COMMENT '1=Yes,0=No',
  `new_arrival` enum('1','0') DEFAULT '0' COMMENT '1=Yes,0=No',
  `status` enum('0','1','2') DEFAULT '1' COMMENT '1=active,0=inactive,2=deleted',
  `city` varchar(255) DEFAULT NULL,
  `pincode` varchar(255) DEFAULT NULL,
  `course_added_date` varchar(255) DEFAULT NULL,
  `course_updated_date` datetime DEFAULT NULL,
  `courses_viewed` int(10) UNSIGNED DEFAULT '0',
  PRIMARY KEY (`courses_id`)
) ENGINE=MyISAM AUTO_INCREMENT=3 DEFAULT CHARSET=utf8;

--
-- Dumping data for table `wl_courses`
--

INSERT INTO `wl_courses` (`courses_id`, `category_id`, `teacher_id`, `category_links`, `course_name`, `course_friendly_url`, `course_code`, `courses_description`, `course_price`, `course_discounted_price`, `hot_course`, `featured_course`, `new_arrival`, `status`, `city`, `pincode`, `course_added_date`, `course_updated_date`, `courses_viewed`) VALUES
(1, NULL, NULL, '', 'test', 'test', 'test', '<p>test</p>\r\n', '1111', '111', '0', '0', '1', '1', 'test1', '110092', '2019-06-12 18:02:20', NULL, 0),
(2, NULL, NULL, NULL, 'Courses', 'courses', 'Courses', '<p>Courses</p>\r\n', '100', '99', '0', '0', '0', '1', 'test2', '110096', '2019-06-12 18:07:37', NULL, 0);

-- --------------------------------------------------------

--
-- Table structure for table `wl_courses_media`
--

DROP TABLE IF EXISTS `wl_courses_media`;
CREATE TABLE IF NOT EXISTS `wl_courses_media` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_products_images_products_id` (`courses_id`)
) ENGINE=MyISAM AUTO_INCREMENT=31 DEFAULT CHARSET=utf8;

--
-- Dumping data for table `wl_courses_media`
--

INSERT INTO `wl_courses_media` (`id`, `courses_id`, `color_id`, `media_type`, `media`, `is_default`, `sort_order`, `media_date_added`, `media_status`) VALUES
(30, 2, NULL, 'photo', 'course-detailsWtep.jpg', 'N', NULL, '2019-06-12 18:07:37', '1'),
(29, 2, NULL, 'photo', 'book-5IRmj.png', 'N', NULL, '2019-06-12 18:07:37', '1'),
(28, 1, NULL, 'photo', 'course-detailsQPqU.jpg', 'N', NULL, '2019-06-12 18:02:20', '1'),
(27, 1, NULL, 'photo', 'book-58GDf.png', 'N', NULL, '2019-06-12 18:02:20', '1');

-- --------------------------------------------------------

--
-- Table structure for table `wl_courses_related`
--

DROP TABLE IF EXISTS `wl_courses_related`;
CREATE TABLE IF NOT EXISTS `wl_courses_related` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `wl_customers` (
  ...
  `account_updated_date` varchar(100) DEFAULT NULL,
...
INSERT INTO `wl_customers` (`customers_id`, `user_name`, `password`, `title`, `first_name`, `last_name`, `gender`, `customer_photo`, `phone_number`, `mobile_number`, `fax_number`, `actkey`, `status`, `is_verified`, `login_type`, `account_created_date`, `account_updated_date`, `current_login`, `last_login_date`, `ip_address`, `is_blocked`, `block_time`, `number_of_login_try`, `oauth_uid`, `picture`, `father_name`, `address`, `description`, `nationality`, `pincode`, `class`, `subject`) VALUES
(11, 'murli101092@gmail.com', '', NULL, 'Sushant1', 'Roy', '', NULL, NULL, NULL, NULL, '34a468aac8c94eef63c4ed62e014be1c', '1', '1', 'facebook', '2019-06-03 10:48:09', '2019-06-03 10:48:09', '2019-06-03 10:48:09', NULL, '::1', '0', NULL, 0, '2201648443284003', 'https://platform-lookaside.fbsbx.com/platform/profilepic/?asid=2201648443284003&height=50&width=50&ext=1562150891&hash=AeTQ8fnmcu7Rhu4P', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(12, 'sushantroy111@gmail.com', '123456', NULL, 'sushant2', NULL, 'M', '', '7503066930', NULL, NULL, 'aa979292a59d014b413848477611ea96', '1', '1', 'normal', '2019-06-06 19:28:33', NULL, '2019-06-23 04:29:53', '2019-06-16 07:32:37', '::1', '0', NULL, 0, '', 'service-10u0lS.png', NULL, 'delano', '7503066930', NULL, '110092', 'Class 6', 'Maths'),
(13, 'murli1010921@gmail.com', '', NULL, 'Sushant test1', 'Roy', 'M', NULL, NULL, NULL, NULL, '34a468aac8c94eef63c4ed62e014be1c', '1', '1', 'facebook', '2019-06-03 10:48:09', '2019-06-03 10:48:09', '2019-06-03 10:48:09', NULL, '::1', '0', NULL, 0, '2201648443284003', 'https://platform-lookaside.fbsbx.com/platform/profilepic/?asid=2201648443284003&height=50&width=50&ext=1562150891&hash=AeTQ8fnmcu7Rhu4P', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(14, 'sushantroy1111@gmail.com', '123456', NULL, 'sushant test2', NULL, 'M', '', '7503066930', NULL, NULL, 'aa979292a59d014b413848477611ea96', '1', '1', 'normal', '2019-06-06 19:28:33', NULL, '2019-06-23 04:29:53', '2019-06-16 07:32:37', '::1', '0', NULL, 0, '', 'service-10u0lS.png', NULL, 'delano', '7503066930', NULL, '110092', 'Class 6', 'Maths'),
(15, 'murli1010921@gmail.com', '', NULL, 'Sushant test3', 'Roy', 'M', NULL, NULL, NULL, NULL, '34a468aac8c94eef63c4ed62e014be1c', '1', '1', 'facebook', '2019-06-03 10:48:09', '2019-06-03 10:48:09', '2019-06-03 10:48:09', NULL, '::1', '0', NULL, 0, '2201648443284003', 'https://platform-lookaside.fbsbx.com/platform/profilepic/?asid=2201648443284003&height=50&width=50&ext=1562150891&hash=AeTQ8fnmcu7Rhu4P', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(16, 'sushantroy@gmail.com', '123456', NULL, 'sushant', NULL, 'M', '', '7503066930', NULL, NULL, 'aa979292a59d014b413848477611ea96', '1', '1', 'normal', '2019-06-06 19:28:33', NULL, '2019-06-23 04:29:53', '2019-06-16 07:32:37', '::1', '0', NULL, 0, '', 'service-10u0lS.png', NULL, 'delano', '7503066930', NULL, '110092', 'Class 6', 'Maths'),
(17, 'murli@gmail.com', '', NULL, 'Sushant test4', 'Roy', 'M', NULL, NULL, NULL, NULL, '34a468aac8c94eef63c4ed62e014be1c', '1', '1', 'facebook', '2019-06-03 10:48:09', '2019-06-03 10:48:09', '2019-06-03 10:48:09', NULL, '::1', '0', NULL, 0, '2201648443284003', 'https://platform-lookaside.fbsbx.com/platform/profilepic/?asid=2201648443284003&height=50&width=50&ext=1562150891&hash=AeTQ8fnmcu7Rhu4P', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(18, 'sushantroy1@gmail.com', '123456', NULL, 'sushant test5', NULL, 'M', '', '7503066930', NULL, NULL, 'aa979292a59d014b413848477611ea96', '1', '1', 'normal', '2019-06-06 19:28:33', NULL, '2019-06-23 04:29:53', '2019-06-16 07:32:37', '::1', '0', NULL, 0, '', 'service-10u0lS.png', NULL, 'delano', '7503066930', NULL, '110092', 'Class 6', 'Maths');
...
INSERT INTO `wl_enquiry` (`id`, `type`, `product_service`, `email`, `first_name`, `last_name`, `company_name`, `country`, `state`, `city`, `phone_number`, `mobile`, `fax_number`, `address`, `zipcode`, `subject`, `message`, `status`, `reply_status`, `receive_date`) VALUES
(10, '3', NULL, 'test@gmail.com', 'Manosh', NULL, NULL, NULL, NULL, NULL, '342423', '42343242', NULL, NULL, NULL, NULL, 'testing', '1', 'N', '2013-07-23 08:32:24'),
(11, '3', NULL, 'sushantroy111@gmail.com', 'sushant', NULL, NULL, NULL, NULL, NULL, '7503066930', NULL, NULL, NULL, NULL, NULL, 'test', '1', 'N', '2019-06-09 17:06:27');
...
(2, 'test', 'images2nnB.jpg', NULL, NULL, '<p>test</p>', NULL, NULL, '0', '2017-09-20 16:04:57', 'N', NULL);
...
CREATE TABLE IF NOT EXISTS `wl_order` (
  ...
  `order_status` enum('Pending','Canceled','Delivered','Ready For Dispatch','Deleted') NOT NULL DEFAULT 'Pending' COMMENT '''Pending'',''Closed'',''Canceled'',''Delivered'',''Ready For Dispatch'',''Rejected'',''Deleted''',
  `order_received_date` varchar(255) DEFAULT '0000-00-00 00:00:00',
  `order_delivery_date` varchar(255) DEFAULT '0000-00-00 00:00:00',
...
INSERT INTO `wl_order` (`order_id`, `teacher_id`, `plan_id`, `view`, `starting_date`, `end_date`, `invoice_number`, `first_name`, `last_name`, `phone`, `email`, `total_amount`, `vat_amount`, `tax_amount`, `tax_type`, `currency_code`, `currency_value`, `order_status`, `order_received_date`, `order_delivery_date`, `payment_method`, `payment_status`) VALUES
(1, 0, 0, 0, NULL, NULL, 'Wl_1', 'dsfsfsa', NULL, NULL, 'test@gmail.com', '90.0000', NULL, '2.00', '%', 'USD', '1.000000', 'Delivered', '2013-07-18 06:10:26', '0000-00-00 00:00:00', 'paypal', 'Unpaid'),
(2, 3, 0, 0, NULL, NULL, 'Wl_2', 'manishss', NULL, NULL, 'weblink.manish84@gmail.com', '30000.0000', NULL, '2.00', '%', 'USD', '1.000000', 'Deleted', '2013-07-18 06:43:26', '0000-00-00 00:00:00', 'paypal', 'Unpaid'),
(3, 0, 0, 0, NULL, NULL, 'Wl_3', 'fsdfsa', NULL, NULL, 'test@gmail.com', '30058.0000', NULL, '2.00', '%', 'USD', '1.000000', 'Deleted', '2013-07-22 11:10:03', '0000-00-00 00:00:00', '', 'Unpaid'),
(4, 3, 0, 0, NULL, NULL, 'Wl_4', 'manishss', NULL, NULL, 'weblink.manish84@gmail.com', '58.0000', NULL, '2.00', '%', 'USD', '1.000000', 'Deleted', '2013-07-22 11:48:50', '0000-00-00 00:00:00', '', 'Unpaid'),
(5, 5, 0, 0, NULL, NULL, 'Wl_5', 'sdfsfsda', NULL, NULL, 'ddddd@gmail.com', '30000.0000', NULL, '2.00', '%', 'USD', '1.000000', 'Deleted', '2013-07-22 12:35:04', '0000-00-00 00:00:00', '', 'Unpaid'),
(6, 5, 0, 0, NULL, NULL, 'Wl_6', 'sdfsfsda', NULL, NULL, 'ddddd@gmail.com', '50.0000', NULL, '2.00', '%', 'USD', '1.000000', 'Deleted', '2013-07-22 13:02:59', '0000-00-00 00:00:00', 'paypal', 'Unpaid'),
(7, 0, 0, 0, NULL, NULL, 'Wl_7', 'sdsffsad', NULL, NULL, 'test@gmail.com', '30000.0000', NULL, '2.00', '%', 'USD', '1.000000', 'Deleted', '2013-07-23 04:11:20', '0000-00-00 00:00:00', '', 'Unpaid'),
(8, 0, 0, 0, NULL, NULL, 'Wl_8', 'dsfdsfs', NULL, NULL, 'test@gmail.com', '30090.0000', NULL, '2.00', '%', 'USD', '1.000000', 'Deleted', '2013-07-23 07:07:57', '0000-00-00 00:00:00', 'paypal', 'Unpaid'),
(9, 3, 0, 0, NULL, NULL, 'Wl_9', 'manishss', NULL, NULL, 'weblink.manish84@gmail.com', '30090.0000', NULL, '2.00', '%', 'USD', '1.000000', 'Deleted', '2013-07-23 09:05:07', '0000-00-00 00:00:00', '', 'Unpaid'),
(10, 0, 0, 0, NULL, NULL, 'Wl_10', 'saddsa', NULL, NULL, 'r.ravinder2012@gmail.com', '30000.0000', NULL, '2.00', '%', 'USD', '1.000000', 'Deleted', '2013-07-24 05:25:36', '0000-00-00 00:00:00', 'paypal', 'Paid'),
(11, 9, 0, 0, NULL, NULL, 'Wl_11', 'sushant kumar', NULL, NULL, 'sushantroy111@gmail.com', '45.0000', NULL, '2.00', '%', 'USD', '1.000000', 'Pending', '2018-10-26 07:23:06', '0000-00-00 00:00:00', '', 'Unpaid');
...
--
-- Table structure for table `wl_plan`
--

DROP TABLE IF EXISTS `wl_plan`;
CREATE TABLE IF NOT EXISTS `wl_plan` (
  `plan_id` int(11) NOT NULL AUTO_INCREMENT,
  `plan_parent_id` int(11) NOT NULL DEFAULT '0',
  ...
  `sort_order` int(11) DEFAULT '0',
  `status` enum('1','2','3') NOT NULL DEFAULT '1',
  `plan_date_added` datetime NOT NULL,
  `plan_updated_at` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`plan_id`)
) ENGINE=MyISAM AUTO_INCREMENT=23 DEFAULT CHARSET=latin1;

--
-- Dumping data for table `wl_plan`
--

INSERT INTO `wl_plan` (`plan_id`, `plan_parent_id`, `name`, `price`, `validity`, `detail`, `sort_order`, `status`, `plan_date_added`, `plan_updated_at`) VALUES
(14, 0, 'Silver', '550', '3', '<ul class=\"list-group list-group-flush text-center\">\r\n               <li class=\"list-group-item\"><i class=\"fa fa-check text-info\"></i> </li>\r\n                <li class=\"list-group-item\"><i class=\"fa fa-check text-info\"></i> Unlimited projects</li>\r\n                <li class=\"list-group-item\"><i class=\"fa fa-check text-info\"></i> 27/7 support</li>\r\n              </ul>', 1, '1', '2013-07-16 07:25:34', '2019-06-15 14:01:26'),
(15, 0, 'Gold', '11111', '3', '<ul class=\"list-group list-group-flush text-center\">\r\n               <li class=\"list-group-item\"><i class=\"fa fa-check text-info\"></i> </li>\r\n                <li class=\"list-group-item\"><i class=\"fa fa-check text-info\"></i> Unlimited support</li>\r\n                <li class=\"list-group-item\"><i class=\"fa fa-check text-info\"></i> 27/7 support</li>\r\n              </ul>', 2, '1', '2013-07-16 07:25:39', '2019-06-15 14:01:39'),
(21, 0, 'Platinum', '1000', '111', '<ul class=\"list-group list-group-flush text-center\">\r\n               <li class=\"list-group-item\"><i class=\"fa fa-check text-info\"></i> </li>\r\n                <li class=\"list-group-item\"><i class=\"fa fa-check text-info\"></i> Unlimited support</li>\r\n                <li class=\"list-group-item\"><i class=\"fa fa-check text-info\"></i> 27/7 support</li>\r\n              </ul>', 3, '1', '2019-06-14 18:19:54', '2019-06-15 14:01:45'),
(22, 0, 'Free', '00.00', '1', 'Free', 4, '1', '2019-06-22 20:13:32', NULL);
...
(13, 33, '33,30', 'DNV test', 'dnv-test', 'sadfasdf', '<p>sdfasdfasdf</p>\r\n', '2,4', '1,2,4', '1', 100, 0, NULL, NULL, 1, NULL, NULL, NULL, 1, 1, NULL, '1111', '111', '0', '0', '0', '1', '2019-06-13 16:54:33', NULL, 0),
(14, 34, '34,30', 'adfasdasdf', 'adfasdasdf', 'adfasdfasf', '<p>dsfasdfadsfasdf</p>\r\n', '1,2', '1,2', '2', 100, 0, NULL, NULL, 1, NULL, NULL, NULL, 1, 1, NULL, '1111', '11', '0', '0', '0', '1', '2019-06-13 16:55:01', NULL, 0);
...
--
-- Table structure for table `wl_subject`
--

DROP TABLE IF EXISTS `wl_subject`;
CREATE TABLE IF NOT EXISTS `wl_subject` (
  `subject_id` int(11) NOT NULL AUTO_INCREMENT,
  `subjecy_name` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `friendly_url` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `subject_image` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `subject_description` text CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `parent_id` int(11) NOT NULL DEFAULT '0',
  `sort_order` int(3) DEFAULT NULL,
  `date_added` varchar(255) COLLATE utf8_bin DEFAULT '0000-00-00 00:00:00',
  `date_modified` varchar(255) COLLATE utf8_bin DEFAULT '0000-00-00 00:00:00',
...
--
-- Dumping data for table `wl_subject`
--

INSERT INTO `wl_subject` (`subject_id`, `subjecy_name`, `friendly_url`, `subject_image`, `subject_description`, `parent_id`, `sort_order`, `date_added`, `date_modified`, `status`, `meta_title`, `meta_keywords`, `meta_description`) VALUES
...
--
-- Table structure for table `wl_teacher`
--

DROP TABLE IF EXISTS `wl_teacher`;
CREATE TABLE IF NOT EXISTS `wl_teacher` (
  ...
  `plan_expire` varchar(255) DEFAULT NULL,
  `profile_edit` enum('0','1') NOT NULL DEFAULT '0',
  PRIMARY KEY (`teacher_id`)
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=latin1;

--
-- Dumping data for table `wl_teacher`
--

INSERT INTO `wl_teacher` (`teacher_id`, `user_name`, `password`, `title`, `first_name`, `last_name`, `gender`, `customer_photo`, `phone_number`, `mobile_number`, `fax_number`, `actkey`, `status`, `is_verified`, `login_type`, `account_created_date`, `account_updated_date`, `current_login`, `last_login_date`, `ip_address`, `is_blocked`, `block_time`, `number_of_login_try`, `oauth_uid`, `picture`, `address`, `description`, `nationality`, `pincode`, `class`, `subject`, `current_credit`, `plan_expire`, `profile_edit`) VALUES
(11, 'murli101092@gmail.com', '123456', NULL, 'Sushant', 'Roy', '', NULL, NULL, NULL, NULL, '34a468aac8c94eef63c4ed62e014be1c', '1', '1', 'facebook', '2019-06-03 10:48:09', '2019-06-03 10:48:09', '2019-06-03 10:48:09', NULL, '::1', '0', NULL, 0, '2201648443284003', 'https://platform-lookaside.fbsbx.com/platform/profilepic/?asid=2201648443284003&height=50&width=50&ext=1562150891&hash=AeTQ8fnmcu7Rhu4P', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '0'),
(12, 'sushantroy111@gmail.com', '123456', NULL, 'sushant', NULL, 'M', '', '7503066930', NULL, NULL, 'aa979292a59d014b413848477611ea96', '1', '1', 'normal', '2019-06-06 19:28:33', NULL, '2019-06-23 19:44:49', '2019-06-23 19:44:17', '::1', '0', NULL, 0, '', NULL, 'delano', '7503066930', NULL, NULL, 'Class 6', 'Maths', '86', NULL, '1');

-- --------------------------------------------------------

--
-- Table structure for table `wl_teacher_cradit_recode`
--

DROP TABLE IF EXISTS `wl_teacher_cradit_recode`;
CREATE TABLE IF NOT EXISTS `wl_teacher_cradit_recode` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `teacher_id` int(11) DEFAULT NULL,
...
--
-- Dumping data for table `wl_teacher_cradit_recode`
--

INSERT INTO `wl_teacher_cradit_recode` (`id`, `teacher_id`, `student_id`, `notified_id`, `value`, `view`, `comment`, `status`, `created_at`) VALUES
(1, 12, 11, 12, '99', 1, 'view profile', '1', '2019-06-23 15:57:37'),
(28, 12, 13, 2, '87', 1, 'view profile', '1', '2019-06-23 16:37:33'),
(24, 12, 11, 1, '91', 1, 'view profile', '1', '2019-06-23 16:23:40'),
(29, 12, 15, 4, '86', 1, 'view profile', '1', '2019-06-23 19:46:10');

-- --------------------------------------------------------

--
-- Table structure for table `wl_teacher_notified`
--

DROP TABLE IF EXISTS `wl_teacher_notified`;
CREATE TABLE IF NOT EXISTS `wl_teacher_notified` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `student_id` int(11) NOT NULL,
...
--
-- Dumping data for table `wl_teacher_notified`
--

INSERT INTO `wl_teacher_notified` (`id`, `student_id`, `teacher_id`, `status`, `subjects`, `classes`, `keyword`, `created_at`) VALUES
(1, 11, 12, '1', 'Math', 'class5', 'Test Case1', '2019-06-23'),
(2, 13, 12, '1', 'Science', 'class6', 'Test Case2', '2019-06-23'),
(3, 14, 12, '1', 'Math', 'class7', 'Test Case3', '2019-06-23'),
(4, 15, 12, '1', 'Science', 'class8', 'Test Case4', '2019-06-23'),
(5, 11, 12, '1', 'Math', 'class5', 'Test Case1', '2019-06-23'),
(6, 13, 12, '1', 'Science', 'class6', 'Test Case2', '2019-06-23'),
(7, 14, 12, '1', 'Math', 'class7', 'Test Case3', '2019-06-23'),
(8, 15, 12, '1', 'Science', 'class8', 'Test Case4', '2019-06-23'),
(9, 11, 12, '1', 'Math', 'class5', 'Test Case1', '2019-06-23'),
(10, 13, 12, '1', 'Science', 'class6', 'Test Case2', '2019-06-23'),
(11, 14, 12, '1', 'Math', 'class7', 'Test Case3', '2019-06-23'),
(12, 15, 12, '1', 'Science', 'class8', 'Test Case4', '2019-06-23'),
(13, 11, 12, '1', 'Math', 'class5', 'Test Case1', '2019-06-23'),
(14, 13, 12, '1', 'Science', 'class6', 'Test Case2', '2019-06-23'),
(15, 14, 12, '1', 'Math', 'class7', 'Test Case3', '2019-06-23'),
(16, 15, 12, '1', 'Science', 'class8', 'Test Case4', '2019-06-23'),
(17, 11, 12, '1', 'Math', 'class5', 'Test Case1', '2019-06-23'),
(18, 13, 12, '1', 'Science', 'class6', 'Test Case2', '2019-06-23'),
(19, 14, 12, '1', 'Math', 'class7', 'Test Case3', '2019-06-23'),
(20, 15, 12, '1', 'Science', 'class8', 'Test Case4', '2019-06-23'),
(21, 11, 12, '1', 'Math', 'class5', 'Test Case1', '2019-06-23'),
(22, 13, 12, '1', 'Science', 'class6', 'Test Case2', '2019-06-23'),
(23, 14, 12, '1', 'Math', 'class7', 'Test Case3', '2019-06-23'),
(24, 15, 12, '1', 'Science', 'class8', 'Test Case4', '2019-06-23'),
(25, 11, 12, '1', 'Math', 'class5', 'Test Case1', '2019-06-23'),
(26, 13, 12, '1', 'Science', 'class6', 'Test Case2', '2019-06-23'),
(27, 14, 12, '1', 'Math', 'class7', 'Test Case3', '2019-06-23'),
(28, 15, 12, '1', 'Science', 'class8', 'Test Case4', '2019-06-23'),
(29, 11, 12, '1', 'Math', 'class5', 'Test Case1', '2019-06-23'),
(30, 13, 12, '1', 'Science', 'class6', 'Test Case2', '2019-06-23'),
(31, 14, 12, '1', 'Math', 'class7', 'Test Case3', '2019-06-23'),
(32, 15, 12, '1', 'Science', 'class8', 'Test Case4', '2019-06-23');

-- --------------------------------------------------------

--
-- Table structure for table `wl_teacher_profile`
--

DROP TABLE IF EXISTS `wl_teacher_profile`;
CREATE TABLE IF NOT EXISTS `wl_teacher_profile` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `wl_teacher_profile`
--

INSERT INTO `wl_teacher_profile` (`id`, `teacher_id`, `subject`, `class`, `location`, `fee`, `status`, `created_at`) VALUES
(1, '12', '7', '32', 'delhi', NULL, '1', NULL),
(2, '12', '8', '33', 'delhi', NULL, '1', NULL);
