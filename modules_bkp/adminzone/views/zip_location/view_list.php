<?php $this->load->view('includes/header'); ?>  
 ...
 <div class="box">
    ...
    <div class="heading">
      ...
      <div class="buttons">  <?php echo anchor("adminzone/zip_location/add/",'<span>Add Zip Location</span>','class="button" ' );?></div>
     ...
     <?php echo error_message(); ?>
      ...
      <?php 
	       ...
	       echo form_open("adminzone/zip_location/",'id="search_form" method="get" ');?>
					 ...
					 <?php if($this->input->get_post('keyword')!='')
					   {
					     ...
					     echo anchor("adminzone/zip_location/",'<span>Clear Search</span>');
	 ...
	 <?php 
	   if( is_array($res) && !empty($res) )
	  {
	    ...
	    echo form_open("adminzone/zip_location/",'id="data_form"');?>
	  ...
	  <table class="list" width="100%" id="my_data">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="center"><?php echo anchor("adminzone/zip_location/edit/$pageVal[zip_location_id]/".query_string(),'Edit'); ?></td>
          </tr>
          <?php
		   $j++;}		  
		  ?> 
