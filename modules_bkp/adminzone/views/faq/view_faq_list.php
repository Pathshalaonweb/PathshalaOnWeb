...
<div class="box">
  ...
  <div class="content">
    <?php 
	 ...
	 echo form_open("adminzone/faq/",'id="search_form" method="get"');?>
        ...
        <td align="center" >Search (<span class="left">Question</span>)
          ...
          <?php	
					 ...
					 { 
					    ...
					    echo anchor("adminzone/faq/",'<span>View All</span>');
    ...
    <?php 
...

		 {
		  ...
		  echo form_open("adminzone/faq/",'id="data_form" ');
    ...
    <table class="list" width="100%" id="my_data">
      <thead>
        <tr>
          ...
          <td width="405" class="left">Question</td>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td class="left"><?php echo $pageVal['faq_question'];?></td>
          <td class="center"><a href="#"  onclick="$('#dialog_<?php echo $pageVal['faq_id'];?>').dialog( {width: 650} );">View Detail</a>
            <div id="dialog_<?php echo $pageVal['faq_id'];?>" title="Answer" style="display:none;"> <?php echo $pageVal['faq_answer'];?></div></td>
          <td class="center"><input type="text" name="ord[<?php echo $pageVal['faq_id'];?>]" value="<?php echo $pageVal['sort_order'];?>" size="2"  /></td>
          <td class="center"><?php echo ($pageVal['status']==1)?"Active":"In-active";?></td>
          <td class="center"><?php echo anchor("adminzone/faq/edit/$pageVal[faq_id]/".query_string(),'Edit'); ?></td>
        </tr>
        <?php
