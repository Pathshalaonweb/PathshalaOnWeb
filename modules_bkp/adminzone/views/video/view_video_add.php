<?php $this->load->view('includes/header'); ?>  
 ...
 <div class="box">
	...
	<div class="content">
		...
		<?php echo form_open_multipart('adminzone/video/add/');?>  
		<div id="tab_pinfo">
			...
			<tr class="trOdd">
			  ...
			  <td align="left"><input type="text" name="video_title" size="50" value="<?php echo set_value('video_title',$this->input->post('video_title'));?>" /></td>
			  </tr>
			<tr class="trOdd">
