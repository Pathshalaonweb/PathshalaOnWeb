...
<div class="box">
  ...
  <div class="content"> <?php echo validation_message();?> <?php echo error_message(); ?> <?php echo form_open_multipart('adminzone/language/word_add/');?>
    <table width="90%"  class="tableList" align="center">
      <tr>
        <th colspan="2" align="center" > </th>
      </tr>
      <tr class="trOdd">
        <td height="26">word : <span class="required">*</span></td>
        <td><input type="text" name="word" size="80" value="<?php echo set_value('word');?>"></td>
      </tr>
