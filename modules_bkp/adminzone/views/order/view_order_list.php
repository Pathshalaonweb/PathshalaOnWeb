    ...
    <table class="list" width="100%" id="my_data">
      <thead>
        <tr>
          ...
          <td width="144" class="center">Order Status</td>
        </tr>
      </thead>
      <tbody>
        <?php 	
        ...
        <tr>
          ...
          <td align="center"><?php echo $pageVal['payment_status'];?> <br />
            <?php if($pageVal['payment_status']=='Unpaid')
					{
						?>
            <a  onclick="return confirm('Are you sure you want to make this order paid');" href="<?php echo base_url();?>adminzone/orders/make_paid/<?php echo $pageVal['order_id'];?>" >Make Paid</a>
            <?php
					}
					?></td>
          <td class="center"><?php  echo $pageVal['order_status']; ?></td>
        </tr>
        <?php
			}		   
			?>
