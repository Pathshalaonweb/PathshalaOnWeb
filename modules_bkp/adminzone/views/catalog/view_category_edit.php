    ...
    <div id="tab_pinfo">
      <table width="90%"  class="form"  cellpadding="3" cellspacing="3">
        ...
        <tr class="trOdd">
          ...
          <td width="72%" align="left"><input type="text" name="category_name" size="40" value="<?php echo set_value('category_name',$catresult['category_name']);?>"></td>
        </tr>
        <tr class="trOdd">
          <td width="28%" height="26" align="right" >Image :</td>
          <td align="left"><input type="file" name="category_image" />
            <?php
            ...
            <div id="dialog" title="Category Image" style="display:none;"> <img src="<?php echo base_url().'uploaded_files/category/'.$catresult['category_image'];?>"  /> </div></td>
        </tr>
        ...
        <tr class="trOdd">
          ...
          <td align="left"><input type="submit" name="sub" value="Update" class="button2" />
            ...
            <input type="hidden" name="category_id" value="<?php echo $catresult['category_id'];?>"></td>
        </tr>
      </table>
    </div>
