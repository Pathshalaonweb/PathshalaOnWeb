...
<div class="box">
  <div class="heading">
    ...
    <div class="buttons"> <a href="javascript:void(0);" onclick="history.back();" class="button">Cancel</a> </div>
  </div>
  <div class="content"> <?php echo validation_message('alert');?> <?php echo error_message(); ?> <?php echo form_open_multipart("adminzone/category/add/".$parent_id);?>
    <div id="tab_pinfo">
      <table width="90%"  class="form"  cellpadding="3" cellspacing="3">
        ...
        <tr class="trOdd">
          ...
          <td align="left"><input type="file" name="category_image" />
            <br />
            <br />
            [ <?php echo $this->config->item('category.best.image.view');?> ] </td>
        </tr>
