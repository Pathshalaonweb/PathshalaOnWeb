			...
			?> 
				<tr>
					...
					<td class="left">
						...
						{
							echo "<br><br>".anchor("adminzone/products/index/".$pageVal['category_id'],'Products ['. $total_products.']','class="refSection" ' );
						}else
						{
								echo "<br><br>".anchor("adminzone/category/index/".$pageVal['category_id'],'Subcategory ['. $total_subcategory.']','class="refSection" ');
								
								echo " | ".anchor("adminzone/products/index/".$pageVal['category_id'],'Products ['. $total_products.']','class="refSection" ');
