...
<div id="content">
  ...
  <div class="breadcrumb">
     ...
     <?php echo anchor('adminzone/dashbord','Home'); ?>&raquo; <?php echo anchor('adminzone/discoupon/','Back To Listing'); ?> &raquo;  <?php echo $heading_title; ?>
 ...
 <div class="box">
    ...
    <div class="heading">
     ...
     <div class="content">
		...
		<?php echo form_open('adminzone/coupons/add/');?>  
		<div id="tab_pinfo">
            ...
            <tr class="trOdd">
                ...
                <input type="text" name="coupon_discount" size="40" value="<?php echo set_value('coupon_discount');?>"> 
             ...
             <tr class="trOdd">
               ...
               <td align="left">
               <input type="text" name="minimum_order_amount" size="40" value="<?php echo set_value('minimum_order_amount');?>" />
               
                 [Ex : Amount: 1520.00 ] </td>
               </tr>
             <tr class="trOdd">
				<td width="28%" height="26" align="right" >Start Date : <span class="required">*</span></td>
				<td width="72%" align="left"><input name="start_date" class="start_date1" type="text" style="padding:2px; width:133px;" value="<?php echo set_value('start_date');?>"><a href="#" class="start_date"><img src="<?php echo base_url();?>assets/developers/images/cal0.png" width="16" height="16" alt=""></a>
             ...
             <tr class="trOdd">
				...
				<td width="72%" align="left">
				 <input name="end_date" class="end_date1" type="text" style="padding:2px; width:133px;" value="<?php echo set_value('end_date');?>"><a href="#" class="end_date"><img src="<?php echo base_url();?>assets/developers/images/cal0.png" width="16" height="16" alt=""></a>
               </td>
			</tr>
