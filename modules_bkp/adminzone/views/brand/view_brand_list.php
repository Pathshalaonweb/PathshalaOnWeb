<?php $this->load->view('includes/header'); ?>  
 ...
 <div class="box">
    ...
    <div class="heading">
      ...
      <div class="buttons">  <?php echo anchor("adminzone/brand/add/",'<span>Add Brand</span>','class="button" ' );?></div>
     ...
     <?php echo error_message(); ?>
      ...
      <?php 
	       ...
	       echo form_open("adminzone/brand/",'id="search_form" method="get" ');?>
             <div align="right" class="breadcrumb"> Records Per Page : <?php echo display_record_per_page();?> </div>
			<table width="100%"  border="0" cellspacing="3" cellpadding="3" >
				<tr>
					<td align="center" >Search [ Brand Name] 
					 ...
					 <?php if($this->input->get_post('keyword')!='')
					   {
					     ...
					     echo anchor("adminzone/brand/",'<span>Clear Search</span>');
	 ...
	 <?php 
	   if( is_array($res) && !empty($res) )
	  {
	    ...
	    echo form_open("adminzone/brand/",'id="data_form"');?>
	  ...
	  <table class="list" width="100%" id="my_data">
        ...
        <thead>
          <tr>
            ...
            <td width="405" class="left">Brand Name</td>
			<td width="343" align="center">Image</td>
        ...
        <tbody>
          ...
          <tr>
            ...
            <input type="checkbox" name="arr_ids[]" value="<?php echo $pageVal['brand_id'];?>" /></td>
		 ...
		 {
		?>
         <a href="#"  onclick="$('#dialog_<?php echo $j;?>').dialog();">View Image </a>
         <div id="dialog_<?php echo $j;?>" title="Banner Image" style="display:none;">
         <img src="<?php echo base_url().'uploaded_files/'.$image_path;?>"  /> </div>
         <?php }else{echo 'No Image';}?>					
				</td>      
            <td class="center"><?php echo ($pageVal['status']==1)?"Active":"In-active";?></td>
            <td class="center"><?php echo anchor("adminzone/brand/edit/$pageVal[brand_id]/".query_string(),'Edit'); ?></td>
          </tr>
          <?php
		   $j++;}		  
		  ?> 
