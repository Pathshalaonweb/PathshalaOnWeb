...
<tr class="trOdd">
	...
	<td width="72%" align="left">
		<input type="text" name="banner_title" value="<?php echo set_value('banner_title',$res->banner_title);?>" />
	</td>
</tr>
<tr class="trOdd">
  <td width="28%" height="26" align="right" > Banner Link1: <span class="required">*</span> </td>
  <td width="72%" align="left">
    <input type="text" name="banner_url" value="<?php echo set_value('banner_url',$res->banner_url);?>" />
  </td>
</tr>
<tr class="trOdd">
  <td width="28%" height="26" align="right" > Banner Link2: <span class="required">*</span> </td>
  <td width="72%" align="left">
    <input type="text" name="bannerOther_url" value="<?php echo set_value('bannerOther_url',$res->bannerOther_url);?>" />
  </td>
</tr>
<tr class="trOdd">
