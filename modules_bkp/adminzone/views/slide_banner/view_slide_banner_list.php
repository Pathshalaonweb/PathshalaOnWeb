	...
	<div class="content">
		...
		if( is_array($res) && !empty($res) )
		{
			...
			<tr>
				...
				<td width="145" class="left">Banner Titlle</td>
				<td width="145" class="left">Banner Link1</td>
				<td width="145" class="left">Banner Link2</td>
		...
		?> 
			<tr>
				...
				<td class="left"><?php echo $pageVal['bannerOther_url'];?></td>	
				<td align="center">
		...
		?>
				  <a href="#"  onclick="$('#dialog_<?php echo $j;?>').dialog({width:'auto'});">View Banner </a>
				...
				<td align="center" >  
                  ...
                  <?php echo anchor("adminzone/slide_banner/edit/$pageVal[banner_id]/".query_string(),'Edit'); ?>         
