	...
	{	
...

	 {
		...
		{			
	        ...
	        $this->form_validation->set_rules('faq_question','Question',"trim|required|max_length[255]|xss_clean|unique[wl_faq.faq_question='".$this->db->escape_str($this->input->post('faq_question'))."' AND status!='2']");
...

	   {
		   ...
		   if(is_array($res) && !empty($res)){ 
		        ...
		        $this->form_validation->set_rules('faq_question','Question',"trim|required|max_length[255]|xss_clean|unique[wl_faq.faq_question='".$this->db->escape_str($this->input->post('faq_question'))."' AND status!='2' AND faq_id!=".$Id."]");
