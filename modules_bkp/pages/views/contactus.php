...
<div class="breadcrumb-area">
    <div class="breadcrumb-top default-overlay bg-img breadcrumb-overly-5 pt-100 pb-95" style="background-image:url(<?php echo theme_url();?>img/bg/breadcrumb-bg-6.jpg);">
        <div class="container">
            <h2>Contact Us</h2>
            ...
            <div class="col-lg-5">
                <div class="contact-form">
                    <div class="contact-title mb-45">
                      ...
                      <input name="email" placeholder="Email*" type="email"value="<?php echo set_value('email');?>" >
        ...
        <div class="row">
            <div class="col-lg-4 col-md-4 col-12">
                <div class="single-contact-info mb-30 text-center">
                    ...
                    <p>Lorem ipsum dolor sit amet <br>Address address.</p>
                </div>
            </div>
            <div class="col-lg-4 col-md-4 col-12">
                <div class="single-contact-info mb-30 text-center">
